        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-10">
          ...
          <div className="squircle-xl p-6 border-linebet/30 relative overflow-hidden">
            ...
            <a
              ...
              rel={AFFILIATE.rel}
              target="_blank"
              className="flex items-center justify-center gap-2 px-4 py-3 btn-linebet cta-glow text-[#0B1220] text-sm font-bold w-full"
            >
          ...
          <div className="squircle-xl p-6 border-star888/30 relative overflow-hidden">
            ...
            <a
              ...
              rel={AFFILIATE.rel}
              target="_blank"
              className="flex items-center justify-center gap-2 px-4 py-3 btn-star888 cta-glow text-[#0B1220] text-sm font-bold w-full"
            >
