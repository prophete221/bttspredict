          ...
          <div className="prose-custom space-y-8">
            ...
            <div className="p-5 rounded-xl bg-gradient-to-r from-or/10 to-gold/10 border border-or/20">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <a href="https://888ghta.com/8hwF6V" rel="sponsored nofollow" target="_blank" className="flex-1 flex items-center justify-center gap-2 px-4 py-2 btn-star888 text-papier text-xs font-bold">
                  <img src="/logos/888starz.svg" alt="888starz" className="h-4 w-auto object-contain" loading="lazy"/>
                  S&apos;inscrire 888starz → 100%
                </a>
              </div>
              <p className="text-[10px] text-cendre mt-2">Code promo : <span className="text-gold font-bold">VISION221</span> — Dépôt minimum 10 000 Fr</p>
            </div>
            ...
            <section>
              ...
              <p className="text-cendre leading-relaxed mt-4">
                ...
                avec les probabilités réelles calculées par nos modèles prédictifs (entraîné sur des matchs analysés),
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                <div className="bg-panel/60 border border-edge rounded-lg p-3 text-center">
                  <p className="text-2xl font-black text-or">~88%</p>
                  <p className="text-[10px] text-cendre mt-1">Taux de réussite FIFA</p>
                </div>
                <div className="bg-panel/60 border border-edge rounded-lg p-3 text-center">
                  <p className="text-2xl font-black text-gold">24/7</p>
                  <p className="text-[10px] text-cendre mt-1">Matchs FIFA en continu</p>
                </div>
                <div className="bg-panel/60 border border-edge rounded-lg p-3 text-center">
                  <p className="text-2xl font-black text-emerald">3 min</p>
                  <p className="text-[10px] text-cendre mt-1">Durée moyenne match</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Délai de recalibration</strong> — Les cotes FIFA sont mises à jour par lots, pas en temps réel. Quand les résultats récents contredisent le modèle du bookmaker, il faut plusieurs cycles avant que les cotes ne soient ajustées. Pendant ce délai, les cotes restent erronées et exploitables.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5">▸</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Biais de surconfiance dans les ratings</strong> — Les bookmakers utilisent principalement le rating global FIFA pour calculer les cotes, mais ce rating ne capture pas les dynamiques spécifiques du jeu virtuel (vitesse des ailiers, efficacité des tirs lointains, force défensive en simulation). Notre modèle intègre ces dimensions supplémentaires.</span>
                </li>
              </ul>
            </section>

            {/* Section 3: Notre équipe détecte la faille */}
            <section>
              <h2 className="text-2xl sm:text-3xl text-papier mb-4" style={{ fontFamily: "var(--font-bebas-neue), 'Bebas Neue', sans-serif", letterSpacing: '0.03em' }}>
              ...
              <div className="space-y-4 mt-6">
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xs font-black text-or bg-or/15 px-2 py-0.5 rounded">ÉTAPE 1</span>
                    <span className="text-papier font-bold text-sm">Collecte en temps réel</span>
                  </div>
                  <p className="text-cendre text-sm leading-relaxed">Notre scraper collecte les cotes de tous les matchs FIFA virtuels sur Linebet et 888starz chaque 30 secondes. Chaque marché (1X2, Over/Under, BTTS) est enregistré avec son timestamp pour analyse.</p>
                </div>
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-cendre text-sm leading-relaxed">Notre moteur IA nouvelle génération, entraîné sur des matchs FIFA analysés, calcule la probabilité réelle de chaque événement en tenant compte de multiples variables : ratings détaillés, forme récente, patterns de variance, heure de la journée, et historique des résultats.</p>
                </div>
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xs font-black text-or bg-or/15 px-2 py-0.5 rounded">ÉTAPE 4</span>
                    <span className="text-papier font-bold text-sm">Envoi du signal VIP</span>
                  </div>
                  <p className="text-cendre text-sm leading-relaxed">Le signal est envoyé aux membres VIP avec le match, le marché, la cote, la probabilité réelle, l&apos;indice de confiance et la mise recommandée. Les signaux de haute confiance (90%+) sont priorisés.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3 mt-6">
                <div className="flex items-start gap-3 p-3 bg-gold/5 border border-gold/15 rounded-lg">
                  ...
                  <div>
                    <p className="text-papier font-semibold text-sm">Inscrivez-vous sur Linebet ou 888starz</p>
                    <p className="text-cendre text-xs mt-1">Utilisez notre lien de parrainage et le code promo <span className="text-gold font-bold">VISION221</span> pour obtenir votre bonus exclusif (150$ sur Linebet, 100% sur 888starz).</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-gold/5 border border-gold/15 rounded-lg">
                  ...
                  <div>
                    <p className="text-papier font-semibold text-sm">Effectuez un dépôt minimum de 10 000 Fr</p>
                    <p className="text-cendre text-xs mt-1">Via Mobile Money, votre méthode de paiement préférée. Le dépôt minimum est requis pour vérifier votre inscription et activer l&apos;accès VIP.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-gold/5 border border-gold/15 rounded-lg">
                ...
                <div className="flex items-start gap-3 p-3 bg-gold/5 border border-gold/15 rounded-lg">
                  ...
                  <div>
                    <p className="text-papier font-semibold text-sm">Recevez les signaux FIFA en temps réel</p>
                    <p className="text-cendre text-xs mt-1">Notre équipe envoie des signaux chaque fois qu&apos;une cote erronée est détectée sur les matchs FIFA, avec le marché, la cote et la confiance.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-gold/5 border border-gold/15 rounded-lg">
                  ...
                  <div>
                    <p className="text-papier font-semibold text-sm">Pariez et gérez vos gains</p>
                    <p className="text-cendre text-xs mt-1">Suivez les signaux, pariez avec discipline (2-5% de bankroll par mise), et retirez vos gains régulièrement. La clé est la gestion du risque.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-or/15 rounded-full flex items-center justify-center text-or text-xs font-bold">IB</div>
                    <div>
                      <p className="text-papier font-semibold text-sm">Ibrahim S.</p>
                ...
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-or/15 rounded-full flex items-center justify-center text-or text-xs font-bold">MD</div>
                    <div>
                      <p className="text-papier font-semibold text-sm">Mamadou D.</p>
                ...
                <div className="bg-dark-800/50 border border-edge rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-or/15 rounded-full flex items-center justify-center text-or text-xs font-bold">PN</div>
                    <div>
                      <p className="text-papier font-semibold text-sm">Patrick N.</p>
                      <p className="text-cendre text-[10px]">Douala, Cameroun</p>
                    </div>
                  </div>
                  <p className="text-cendre text-sm leading-relaxed">Le meilleur investissement que j&apos;ai fait. Avec 10 000 Fr de dépôt et les signaux FIFA, je gagne régulièrement. La clé c&apos;est la discipline — suivre les signaux et ne pas dépasser 3% de bankroll par mise. L&apos;IA ne ment pas.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { q: "Comment BTTSPredict détecte les cotes erronées ?", a: "Notre algorithme IA analyse en temps réel les cotes de chaque match FIFA, les compare aux probabilités réelles calculées par notre modèle (basé sur des matchs analysés), et identifie les écarts significatifs. Quand l'écart dépasse un seuil statistique, un signal est envoyé aux membres VIP." },
                  ...
                  <details key={i} className="bg-dark-800/50 border border-edge rounded-lg group">
                    <summary className="flex items-center justify-between cursor-pointer p-4 text-papier font-semibold text-sm hover:text-or transition-colors">
                      {faq.q}
                      <svg className="w-4 h-4 text-cendre flex-shrink-0 transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>
                    </summary>
                    <p className="px-4 pb-4 text-cendre text-sm leading-relaxed">{faq.a}</p>
                  </details>
                ))}
              </div>
            </section>
            ...
            <div className="p-5 rounded-xl bg-gradient-to-r from-or/15 to-gold/10 border border-or/25">
              ...
              <p className="text-[10px] text-cendre mt-3">Jeu responsable — Ne misez jamais plus que ce que vous pouvez perdre. Résultats passés ≠ garantie future.</p>
            </div>
