        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <header className="mb-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl text-papier mt-4 mb-4 leading-tight" style={{ fontFamily: "var(--font-bebas-neue), 'Bebas Neue', sans-serif", letterSpacing: '0.04em' }}>
              ...
              <span className="text-or" style={{ textShadow: '0 0 8px rgba(224, 193, 145,0.5), 0 0 24px rgba(224, 193, 145,0.3)' }}>
          ...
          <div className="prose-custom space-y-8">
            ...
            <div className="p-5 rounded-xl bg-gradient-to-r from-or/10 to-gold/10 border border-or/20">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <a href="https://lb-aff.com/L?tag=d_5589568m_22611c_site&site=5589568&ad=22611&r=registration" rel="sponsored nofollow" target="_blank" className="flex-1 flex items-center justify-center gap-2 px-4 py-2 btn-linebet text-[#05070A] text-xs font-bold">
