      ...
      <main id="main-content" className="flex-1 relative z-10">
        ...
        <nav aria-label="Fil d'Ariane" className="max-w-4xl mx-auto px-4 sm:px-6 pt-6">
          <ol className="flex items-center gap-2 text-sm text-cendre">
            ...
            <li>
              <span className="text-cendre" aria-current="page">Conditions Générales d&apos;Utilisation</span>
            </li>
          </ol>
        </nav>
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <div className="bg-panel/40 border border-edge/30 rounded-xl p-4 my-3">
                    ...
                    <p className="text-cendre text-sm">
                      BTTSPredict <strong className="text-papier">ne prend aucun pari</strong>, ne collecte <strong className="text-papier">aucun fonds</strong>, ne gère <strong className="text-papier">aucun compte de jeu</strong> et n&apos;agit pas en tant que bookmaker, intermédiaire ou opérateur de jeux d&apos;argent. Les utilisateurs parient à leur entière discrétion et sous leur seule responsabilité sur les plateformes de leur choix.
                    </p>
                  </div>
              ...
              <article className="card p-6">
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  <div className="bg-lose/10 border border-lose/30 rounded-xl p-4 mb-3">
                    ...
                    <p className="text-cendre text-sm">
                      Les pronostics diffusés sur BTTSPredict sont fournis à titre <strong className="text-papier">strictement informatif</strong> et ne constituent en aucun cas des conseils financiers, des incitations à parier ou des garanties de résultat.
                    </p>
                  </div>
                  <p>
              ...
              <article className="card p-6">
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4 text-cendre">
                    <li><strong className="text-cendre">Être majeur :</strong> vous certifiez être âgé de 18 ans ou plus. L&apos;accès au site est strictement interdit aux mineurs. BTTSPredict se réserve le droit de mettre en place des dispositifs de vérification de l&apos;âge.</li>
                    <li><strong className="text-cendre">Respecter les lois locales :</strong> vous êtes responsable de vous assurer que l&apos;utilisation de notre site et la participation à des paris sportifs sont conformes aux lois et réglementations de votre juridiction. Les lois sur les jeux d&apos;argent varient considérablement d&apos;un pays à l&apos;autre.</li>
                    <li><strong className="text-cendre">Jouer de manière responsable :</strong> vous reconnaissez que les paris sportifs comportent des risques financiers et vous vous engagez à jouer de manière responsable, en ne misant jamais plus que ce que vous pouvez vous permettre de perdre. Nous vous invitons à consulter notre page{' '}
                      <a href="/jouer-responsable" className="text-emerald hover:text-emerald-soft transition-colors underline underline-offset-2">
                        Jouer Responsable
                      </a>.
                    </li>
                    <li><strong className="text-cendre">Ne pas utiliser le site à des fins illicites :</strong> vous vous engagez à ne pas utiliser le site d&apos;une manière qui pourrait endommager, désactiver, surcharger ou altérer le fonctionnement du site, ni tenter d&apos;accéder de manière non autorisée à des systèmes, données ou informations liés au site.</li>
                    <li><strong className="text-cendre">Ne pas reproduire le contenu :</strong> vous vous abstiendrez de copier, reproduire, distribuer, publier ou exploiter commercialement tout contenu du site sans autorisation préalable écrite de BTTSPredict.</li>
                    <li><strong className="text-cendre">Fournir des informations exactes :</strong> si vous êtes amené à fournir des informations (contact, commentaires), vous vous engagez à ce qu&apos;elles soient exactes et à jour.</li>
                  </ul>
                </div>
              </article>
