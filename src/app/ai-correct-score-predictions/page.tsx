            ...
            {leagues.map(league => (
              <button
                ...
                className={`px-2.5 py-1 rounded text-[11px] font-semibold transition-all whitespace-nowrap ${
                  activeLeague === league
                    ? 'bg-[#18A879]/15 text-[#18A879] border border-[#18A879]/30'
                ...
                <div key={`${m.home}-${m.away}-${i}`} className="rounded-xl overflow-hidden" style={{ backgroundColor: '#111722', border: '1px solid #3A4556' }}>
                  ...
                  <div className="px-3 py-3">
                    <div className="text-center mb-3">
                      ...
                      <span className="text-[#18A879] mx-2 font-mono text-xs">vs</span>
                      ...
                      {m.topScores.map((s, idx) => (
                        <div key={idx} className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-bold font-mono" style={{ color: idx === 0 ? '#18A879' : '#F7F4EE' }}>{s.score}</span>
                          </div>
                          <div className="flex items-center gap-2 flex-1 ml-3">
                            <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: '#080B12' }}>
                              <div className="h-full rounded-full" style={{ width: `${s.prob * 100}%`, backgroundColor: idx === 0 ? '#18A879' : '#18A879' }} />
                            </div>
