    ...
    >
      <div className="max-w-md text-center">
        ...
        <h1
          ...
          style={{ color: '#F3F7F5', fontFamily: 'Poppins, sans-serif' }}
        >
          Match ou page introuvable
        </h1>
        <p className="text-sm mb-6 leading-relaxed" style={{ color: '#B4C4CC' }}>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          ...
          <Link
            ...
            className="inline-block px-6 py-3 rounded-[10px] font-bold text-sm transition-all"
            style={{ backgroundColor: 'transparent', color: '#F3F7F5', border: '1px solid #23495C' }}
          >
            Pronostics du jour
          </Link>
        </div>
