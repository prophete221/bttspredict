  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex flex-col text-[#F8FAFC]">
      ...
      <main id="main-content" className="flex-1">
        <nav aria-label="Fil d'Ariane" className="text-xs text-[#94A3B8] mb-4 max-w-4xl mx-auto px-4 pt-8">
          <Link href="/" className="hover:text-[#10B981]">Accueil</Link>
          <span className="mx-1">/</span>
          <span className="text-[#94A3B8]">Over 2.5 Statistics</span>
        </nav>
        ...
        <section className="max-w-4xl mx-auto px-4 pb-12">
          <div className="overflow-x-auto rounded-xl" style={{ backgroundColor: '#1E293B', border: '1px solid #334155' }}>
            <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid #334155' }}>
                  <th className="text-left py-3 px-3 font-bold text-[#94A3B8]">League</th>
                  <th className="text-left py-3 px-3 font-bold text-[#94A3B8] hidden sm:table-cell">Country</th>
                  <th className="text-right py-3 px-3 font-bold text-[#94A3B8]">Goals/match</th>
                  <th className="text-right py-3 px-3 font-bold text-[#94A3B8]">Over 2.5 Rate</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/over-2-5/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01]"
              ...
              <div className="text-xs text-[#94A3B8] mt-1">Today's picks</div>
            </Link>
