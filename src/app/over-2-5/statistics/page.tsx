    ...
    <div className="min-h-screen bg-[#07111A] flex flex-col text-[#F2F7F5]">
      ...
      <main id="main-content" className="flex-1">
        <nav aria-label="Fil d'Ariane" className="text-xs text-[#7F969E] mb-4 max-w-4xl mx-auto px-4 pt-8">
          ...
          <span className="text-[#B5C4C9]">Over 2.5 Statistics</span>
        </nav>
            ...
            <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid #1C3546' }}>
                  <th className="text-left py-3 px-3 font-bold text-[#B5C4C9]">League</th>
                  <th className="text-left py-3 px-3 font-bold text-[#B5C4C9] hidden sm:table-cell">Country</th>
                  <th className="text-right py-3 px-3 font-bold text-[#B5C4C9]">Goals/match</th>
                  <th className="text-right py-3 px-3 font-bold text-[#B5C4C9]">Over 2.5 Rate</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/over-2-5/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01]"
              ...
              <div className="text-xs text-[#B5C4C9] mt-1">Today's picks</div>
            </Link>
