    ...
    <div className="min-h-screen bg-[#0F172A] flex flex-col text-[#F8FAFC]">
      ...
      <main id="main-content" className="flex-1">
        <nav aria-label="Fil d'Ariane" className="text-xs text-[#94A3B8] mb-4 max-w-5xl mx-auto px-4 pt-8">
          ...
          <span className="text-[#94A3B8]">Over 2.5 Today</span>
        </nav>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Link href="/over-2-5/statistics" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#10B981]"
              style={{ backgroundColor: '#1E293B', border: '1px solid #334155' }}>
              <div className="text-sm font-bold text-[#F8FAFC]">Over 2.5 Statistics →</div>
