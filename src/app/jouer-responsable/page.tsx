            ...
            <div className="space-y-8">
              ...
              <article className="card p-6">
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4 text-cendre">
                    <li><strong className="text-cendre">Pertes financières :</strong> vous pouvez perdre tout l&apos;argent que vous misez, et potentiellement plus si vous ne gérez pas votre bankroll. L&apos;endettement est une conséquence fréquente du jeu excessif.</li>
                    <li><strong className="text-cendre">Addiction :</strong> les jeux d&apos;argent activent le circuit de la récompense dans le cerveau, de manière similaire aux substances addictives. Le mécanisme de renforcement intermittent (gains occasionnels imprévisibles) est particulièrement puissant pour créer une dépendance.</li>
                    <li><strong className="text-cendre">Impact psychologique :</strong> stress, anxiété, dépression, culpabilité, isolement social et idées noires peuvent accompagner le jeu problématique.</li>
                    <li><strong className="text-cendre">Conséquences sociales :</strong> conflits familiaux, perte d&apos;emploi, isolement, mensonges à l&apos;entourage et détérioration des relations personnelles.</li>
                    <li><strong className="text-cendre">Illusion de contrôle :</strong> la croyance erronée que l&apos;on peut « battre le système » ou que les pronostics garantissent des gains est un facteur de risque majeur.</li>
                  </ul>
                  <p>
                    BTTSPredict fournit des pronostics basés sur l&apos;analyse statistique avec un taux de précision historique d&apos;environ 80%. Toutefois, ce chiffre est basé sur des données passées et ne constitue en aucune manière une garantie de résultats futurs. Même les meilleurs algorithmes ne peuvent pas prédire l&apos;avenir avec certitude.
                  </p>
                </div>
              </article>
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <ul className="space-y-2 ml-2">
                    {addictionSigns.map((sign, i) => (
                      <li key={i} className="flex items-start gap-3 text-cendre">
              ...
              <article className="card p-6">
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4 text-cendre">
                    <li><strong className="text-cendre">Sur Linebet :</strong> vous pouvez activer l&apos;auto-exclusion directement dans les paramètres de votre compte. Des options de 6 mois, 1 an ou indéfinie sont généralement disponibles. Pendant la période d&apos;exclusion, vous ne pourrez ni parier ni effectuer de dépôt.</li>
                    <li><strong className="text-cendre">Sur les autres bookmakers :</strong> la plupart des opérateurs de jeux d&apos;argent proposent des mécanismes similaires. Consultez la section « Jeu responsable » de chaque plateforme.</li>
                    <li><strong className="text-cendre">Au niveau national :</strong> certains pays proposent des registres nationaux d&apos;auto-exclusion qui vous interdisent l&apos;accès à tous les sites de jeux d&apos;argent légaux. Renseignez-vous auprès des autorités de votre pays.</li>
                  </ul>
                  <p>
                    ...
                    {helpResources.map((resource, i) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h3 className="text-papier font-semibold">{resource.name}</h3>
                        </div>
                        <div className="space-y-1 text-cendre text-sm">
                          <p>
              ...
              <article className="card p-6">
                ...
                <div className="space-y-3 text-cendre text-sm leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4 text-cendre">
                    <li><strong className="text-cendre">Transparence :</strong> nous affichons clairement nos taux de précision comme des statistiques historiques, jamais comme des garanties de gains futurs. Nous rappelons systématiquement que les résultats passés ne préjugent pas des résultats futurs.</li>
                    <li><strong className="text-cendre">Information :</strong> chaque page de notre site comporte un avertissement sur les risques liés aux paris sportifs et un lien vers cette page de jeu responsable.</li>
                    <li><strong className="text-cendre">Vérification de l&apos;âge :</strong> nous mettons en place un dispositif de vérification de l&apos;âge pour empêcher l&apos;accès aux mineurs. Le site est strictement réservé aux personnes de 18 ans et plus.</li>
                    <li><strong className="text-cendre">Pas d&apos;incitation excessive :</strong> nos contenus promotionnels sont conçus pour informer, pas pour inciter de manière agressive ou trompeuse au jeu.</li>
                    <li><strong className="text-cendre">Aide accessible :</strong> nous facilitons l&apos;accès aux ressources d&apos;aide et aux numéros d&apos;écoute spécialisés pour nos utilisateurs.</li>
                    <li><strong className="text-cendre">Nature du service :</strong> BTTSPredict est un site informatif et d&apos;affiliation. Nous ne prenons aucun pari, ne collectons aucun fonds et ne sommes pas un bookmaker. Les utilisateurs parient à leur entière discrétion sur les plateformes de leur choix.</li>
                  </ul>
                  <p>
