...
const GOLD = '#7FA2C6'       // v68: or unifié
const PRIMARY = '#7FA2C6'
const PRIMARY_HOVER = '#7FA2C6'
const ORANGE = '#7FA2C6'      // v68: 888Starz card passe d'orange à Émeraude
const ORANGE_DARK = '#A9C4DF' // v68: émeraude sombre pour hover
const TEXT = '#F4F7FB'
const TEXT_SEC = '#C2CCD8'
const BG_DARK = '#0B1220'
const BORDER_OUTLINE = '#C2CCD8'
    ...
    <>
      ...
      {toast && (
        <div
          ...
          style={{
            backgroundColor: toast.startsWith('⚠') ? '#E07A83' : '#7FA2C6',
            color: BG_DARK,
            border: `1.5px solid ${toast.startsWith('⚠') ? '#E07A83' : '#7FA2C6'}`,
      ...
      <section className="pb-6 sm:pb-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center pt-6">
          <span
            ...
            style={{ backgroundColor: 'rgba(127, 162, 198, 0.16)', color: GOLD, border: `1px solid ${GOLD}55` }}
          >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${BG_DARK} 0%, #182438 100%)`,
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{
                    backgroundColor: copiedLinebet ? '#7FA2C6' : `${GOLD}1A`,
                    border: `1px solid ${copiedLinebet ? '#7FA2C6' : GOLD}`,
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  style={{
                    backgroundColor: copiedLinebet ? '#7FA2C6' : GOLD,
                    color: BG_DARK,
                    border: 'none',
                ...
                <a
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#182438' }}
            ...
            >
              ...
              >
                ...
                <span
                  className="inline-flex items-center justify-center w-9 h-9 rounded-lg flex-shrink-0"
                  style={{
                    backgroundColor: copied888 ? '#7FA2C6' : `${ORANGE}1A`,
                    border: `1px solid ${copied888 ? '#7FA2C6' : ORANGE}`,
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="h-[44px] rounded-[10px] font-bold text-[13px] flex items-center justify-center gap-2 transition-all"
                  style={{
                    backgroundColor: copied888 ? '#7FA2C6' : ORANGE,
                    color: BG_DARK,
                    border: 'none',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {STEPS.map((step) => (
              <div
                ...
                style={{ backgroundColor: '#111a2a', border: `1px solid ${GOLD}22` }}
              >
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <div
            ...
            style={{
              ...
              border: `1.5px solid #7FA2C6`,
              boxShadow: '0 0 40px rgba(169, 196, 223, 0.15)',
            }}
          >
            <h2
            ...
            <p className="text-xs text-center mb-5" style={{ color: TEXT_SEC }}>
              On vérifie dans le tableau de bord affilié que le code VISION221 / vision221 a bien été utilisé + dépôt min 3 000 F. Délai <strong style={{ color: '#7FA2C6' }}>15-60 min</strong>.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    ...
                    border: '1.5px solid #7D90A7',
                    color: TEXT,
                    outline: 'none',
                  }}
                  onFocus={(e) => { e.currentTarget.style.borderColor = '#7FA2C6' }}
                  onBlur={(e) => { e.currentTarget.style.borderColor = '#7D90A7' }}
                />
              </div>
              ...
              <a
                ...
                style={{
                  ...
                  color: BG_DARK,
                  border: 'none',
                  boxShadow: '0 6px 20px rgba(169, 196, 223, 0.3)',
                }}
              >
            ...
            <p className="text-[11px] text-center mt-4 leading-relaxed" style={{ color: '#C2CCD8' }}>
              Si OK, accès groupe VIP + 6 pronos BTTS / Over 2.5 par jour avec xG.
              Numéro WhatsApp : <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="underline" style={{ color: '#7FA2C6' }}>+1 540 670 4172</a>
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {ADVANTAGES.map((adv) => (
              <div
                ...
                style={{ backgroundColor: '#111a2a', border: `1px solid ${PRIMARY}22` }}
              >
                <div
              ...
              >
                ...
                <div className="relative z-0">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    <div>
                      <span className="text-[9px] uppercase" style={{ color: '#C2CCD8' }}>xG home</span>
                      <p className="text-base font-black" style={{ color: '#7FA2C6', filter: 'blur(3px)', userSelect: 'none' }}>
                        {match.xgHome}
                      </p>
                    </div>
                    <div>
                      <span className="text-[9px] uppercase" style={{ color: '#C2CCD8' }}>xG away</span>
                      <p className="text-base font-black" style={{ color: '#7FA2C6', filter: 'blur(3px)', userSelect: 'none' }}>
                        {match.xgAway}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-3 pt-3" style={{ borderTop: '1px solid rgba(75, 182, 135, 0.1)' }}>
                    ...
                    <span className="text-sm font-bold" style={{ color: '#7FA2C6', filter: 'blur(3px)', userSelect: 'none' }}>{match.btts}</span>
                  </div>
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-[10px]" style={{ color: TEXT_SEC }}>Over 2.5</span>
                    <span className="text-sm font-bold" style={{ color: '#7FA2C6', filter: 'blur(3px)', userSelect: 'none' }}>{match.over}</span>
                  </div>
                </div>
              </div>
            ))}
          </div>
          <p className="text-center text-[11px] mt-4" style={{ color: '#C2CCD8' }}>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          >
            <p className="text-[11px] leading-relaxed" style={{ color: TEXT_SEC }}>
              <strong style={{ color: '#E07A83' }}>Liens affiliés</strong> — 18+ — Aucune garantie de gain —
              On ne prend pas les paris, on ne collecte pas les fonds — Contact :{' '}
              <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="underline" style={{ color: '#7FA2C6' }}>
                wa.me/15406704172
              </a>
            </p>
          </div>
