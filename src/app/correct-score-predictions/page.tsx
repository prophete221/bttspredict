...
const FAQ = [
  ...
  { q: "Comment BTTSPredict prédit-il les scores exacts ?", a: "Notre moteur IA calcule la probabilité de chaque score possible (0-0, 1-0, 0-1, 1-1, 2-1, etc.) à partir des lambdas de buts attendus des deux équipes. Le score avec la plus haute probabilité est recommandé." },
      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: '#0D1630', border: '1px solid rgba(247, 248, 255, 0.08)' }}>
          ...
          <div className="text-sm leading-relaxed space-y-3" style={{ color: '#A5ABC5' }}>
            <p>Le moteur IA permet de calculer la probabilité de chaque score possible. Pour un match entre l'équipe A (lambda domicile = 1.5) et l'équipe B (lambda extérieur = 1.2), le modèle génère une matrice de probabilités pour tous les scores de 0-0 à 5-5.</p>
