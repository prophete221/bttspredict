      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        <nav aria-label="Fil d'Ariane" className="mb-8">
          <ol className="flex items-center gap-2 text-sm" style={{ color: '#9E9B96' }}>
            ...
            <li style={{ color: '#F6F2E9' }} aria-current="page">Correct Score Predictions</li>
          </ol>
        </nav>
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F6F2E9', fontFamily: 'Poppins, sans-serif' }}>
            Correct Score <span style={{ color: '#E0C191' }}>Predictions</span>
          </h1>
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: '#0F1316', border: '1px solid rgba(246, 242, 233, 0.08)' }}>
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F6F2E9', fontFamily: 'Poppins, sans-serif' }}>Méthodologie score exact</h2>
          <div className="text-sm leading-relaxed space-y-3" style={{ color: '#9E9B96' }}>
            ...
            <p>Pour voir nos pronostics du jour, consultez notre <a href="/" style={{ color: '#E0C191' }}>page d'accueil</a>. Pour comprendre notre modèle en détail, visitez notre page <a href="/methodologie" style={{ color: '#E0C191' }}>méthodologie</a>.</p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F6F2E9', fontFamily: 'Poppins, sans-serif' }}>FAQ Score Exact</h2>
