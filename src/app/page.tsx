    ...
    <div className="min-h-screen bg-dark-800 relative">
      ...
      <div className="sr-only">
        ...
        <p data-snippet>
          ...
          <a href="/equipe" style={{ color: '#A8A29E' }}>découvrez notre équipe</a>{' '}ou{' '}
          <a href="/blog" style={{ color: '#A8A29E' }}>lisez nos analyses sportives</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="/historique" style={{ color: '#A8A29E' }}>historique public vérifiable</a>{' '}
        ...
        <p>
          Notre <a href="/methodologie" style={{ color: '#A8A29E' }}>méthodologie détaillée</a>{' '}
