    ...
    <div className="min-h-screen bg-dark-800 relative">
      ...
      <div className="sr-only">
        ...
        <p data-snippet>
          ...
          <a href="/equipe" style={{ color: '#C9A227' }}>découvrez notre équipe</a>{' '}ou{' '}
          <a href="/blog" style={{ color: '#C9A227' }}>lisez nos analyses sportives</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="/historique" style={{ color: '#C9A227' }}>historique public vérifiable</a>{' '}
        ...
        <p>
          Notre <a href="/methodologie" style={{ color: '#C9A227' }}>méthodologie détaillée</a>{' '}
