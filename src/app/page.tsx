    ...
    <div className="min-h-screen bg-dark-800 relative">
      ...
      <div className="sr-only">
        ...
        <p data-snippet>
          ...
          <a href="/equipe" style={{ color: '#E0C191' }}>découvrez notre équipe</a>{' '}ou{' '}
          <a href="/blog" style={{ color: '#E0C191' }}>lisez nos analyses sportives</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="/historique" style={{ color: '#E0C191' }}>historique public vérifiable</a>{' '}
        ...
        <p>
          Notre <a href="/methodologie" style={{ color: '#E0C191' }}>méthodologie détaillée</a>{' '}
