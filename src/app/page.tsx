    ...
    <div className="min-h-screen bg-dark-800 relative">
      ...
      <div className="sr-only">
        ...
        <p data-snippet>
          ...
          <a href="/equipe" style={{ color: '#D8BA91' }}>découvrez notre équipe</a>{' '}ou{' '}
          <a href="/blog" style={{ color: '#D8BA91' }}>lisez nos analyses sportives</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="/historique" style={{ color: '#D8BA91' }}>historique public vérifiable</a>{' '}
        ...
        <p>
          Notre <a href="/methodologie" style={{ color: '#D8BA91' }}>méthodologie détaillée</a>{' '}
