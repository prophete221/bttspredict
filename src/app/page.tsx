    ...
    <div className="min-h-screen bg-dark-800 relative">
      ...
      <div className="sr-only">
        ...
        <p data-snippet>
          ...
          <a href="/equipe" style={{ color: '#18E0B5' }}>découvrez notre équipe</a>{' '}ou{' '}
          <a href="/blog" style={{ color: '#18E0B5' }}>lisez nos analyses sportives</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="/historique" style={{ color: '#18E0B5' }}>historique public vérifiable</a>{' '}
        ...
        <p>
          Notre <a href="/methodologie" style={{ color: '#18E0B5' }}>méthodologie détaillée</a>{' '}
