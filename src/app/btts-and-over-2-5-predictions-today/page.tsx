    ...
    <div className="min-h-screen bg-[#07111A] flex flex-col text-[#F2F7F5]">
      ...
      <main id="main-content" className="flex-1">
        <nav aria-label="Fil d'Ariane" className="text-xs text-[#7F969E] mb-4 max-w-5xl mx-auto px-4 pt-8">
          ...
          <span className="text-[#B5C4C9]">BTTS + Over 2.5 Today</span>
        </nav>
        ...
        <section className="max-w-5xl mx-auto px-4 pb-8">
          <div className="rounded-xl p-5" style={{ backgroundColor: '#102333', border: '1px solid #1C3546' }}>
            ...
            <p className="text-sm text-[#7F969E] leading-relaxed">
              For the methodology, see our <Link href="/methodologie" className="text-[#C7F464] underline">methodology page</Link>.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/btts/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C7F464]"
              ...
              <div className="text-xs text-[#B5C4C9] mt-1">Both teams to score only</div>
            </Link>
            <Link href="/over-2-5/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C7F464]"
              ...
              <div className="text-xs text-[#B5C4C9] mt-1">Total goals ≥ 3 only</div>
            </Link>
            <Link href="/ai-correct-score-predictions" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C7F464]"
              style={{ backgroundColor: '#102333', border: '1px solid #1C3546' }}>
              <div className="text-sm font-bold text-[#F2F7F5]">AI Correct Score Predictions →</div>
            ...
            <Link href="/resultats-verifies" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C7F464]"
              style={{ backgroundColor: '#102333', border: '1px solid #1C3546' }}>
              <div className="text-sm font-bold text-[#F2F7F5]">Verified Results →</div>
              <div className="text-xs text-[#B5C4C9] mt-1">Historical performance</div>
            </Link>
          </div>
        </section>
      </main>
