    ...
    <div className="min-h-screen bg-[#07131D] flex flex-col text-[#F3F7F5]">
      ...
      <main id="main-content" className="flex-1">
        <nav aria-label="Fil d'Ariane" className="text-xs text-[#B4C4CC] mb-4 max-w-5xl mx-auto px-4 pt-8">
          ...
          <span className="text-[#B4C4CC]">BTTS + Over 2.5 Today</span>
        </nav>
        ...
        <section className="max-w-5xl mx-auto px-4 pb-8">
          <div className="rounded-xl p-5" style={{ backgroundColor: '#0D202D', border: '1px solid #23495C' }}>
            ...
            <p className="text-sm text-[#B4C4CC] leading-relaxed">
              For the methodology, see our <Link href="/methodologie" className="text-[#E6A24C] underline">methodology page</Link>.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/btts/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6A24C]"
              ...
              <div className="text-sm font-bold text-[#F3F7F5]">BTTS Predictions Today →</div>
              <div className="text-xs text-[#B4C4CC] mt-1">Both teams to score only</div>
            </Link>
            <Link href="/over-2-5/predictions/today" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6A24C]"
              style={{ backgroundColor: '#0D202D', border: '1px solid #23495C' }}>
              <div className="text-sm font-bold text-[#F3F7F5]">Over 2.5 Predictions Today →</div>
              <div className="text-xs text-[#B4C4CC] mt-1">Total goals ≥ 3 only</div>
            </Link>
            <Link href="/ai-correct-score-predictions" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6A24C]"
              style={{ backgroundColor: '#0D202D', border: '1px solid #23495C' }}>
              <div className="text-sm font-bold text-[#F3F7F5]">AI Correct Score Predictions →</div>
              <div className="text-xs text-[#B4C4CC] mt-1">Exact score probabilities</div>
            </Link>
            <Link href="/resultats-verifies" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6A24C]"
              style={{ backgroundColor: '#0D202D', border: '1px solid #23495C' }}>
              <div className="text-sm font-bold text-[#F3F7F5]">Verified Results →</div>
              <div className="text-xs text-[#B4C4CC] mt-1">Historical performance</div>
            </Link>
          </div>
        </section>
      </main>
