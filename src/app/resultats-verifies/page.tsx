      ...
      <main id="main-content" className="flex-1 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-sm text-[#C2CCD8]">
          ...
          <div className="mt-8 p-4 rounded-xl bg-[#111a2a] border border-[#7D90A7]">
            <p className="text-[11px] text-[#C2CCD8] leading-relaxed">
              <strong className="text-[#C2CCD8]">Règle d&apos;intégrité :</strong> Aucun pronostic n&apos;est modifié ou supprimé après publication.
