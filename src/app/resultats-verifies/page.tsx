      ...
      <main id="main-content" className="flex-1 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-sm text-[#B7C4C1]">
          ...
          <div className="mt-8 p-4 rounded-xl bg-[#0D1A20] border border-[#5D7880]">
            <p className="text-[11px] text-[#B7C4C1] leading-relaxed">
              <strong className="text-[#B7C4C1]">Règle d&apos;intégrité :</strong> Aucun pronostic n&apos;est modifié ou supprimé après publication.
