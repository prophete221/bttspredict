    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
        ...
        <div className="rounded-[16px] bg-[#192231] border border-[#18A879]/42 p-5" style={{ boxShadow: '0 10px 30px rgba(0,0,0,0.22)' }}>
          ...
          <div className="mt-2 text-[10px] text-[#9BA7B8]">
            Sélection premium
            {showGoldYield && <span className="ml-2 text-[#18A879]">Yield +{goldYield}%</span>}
          </div>
        </div>
                  ...
                  return (
                    <tr key={i} className="border-b border-[#3A4556]/30">
                      ...
                      <td className="py-1.5 px-2 text-[#9BA7B8]">
                        {market}
                        {isGold && <span className="ml-1 text-[10px] text-[#18A879] font-bold">GOLD</span>}
                      </td>
                      ...
                      <td className="py-1.5 px-2 text-center" style={{ color: isWon ? '#18A879' : '#C95A62' }}>
