      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F4F7FA', fontFamily: 'Poppins, sans-serif' }}>
            Les experts derrière <span style={{ color: '#D4AF37' }}>BTTSPredict</span>
          </h1>
            ...
            >
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm mb-3" style={{ color: '#D4AF37', fontWeight: 600 }}>
                    {expert.role}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3 mb-4">
                    {Object.entries(expert.stats).map(([key, value]) => (
                      <div key={key} className="px-3 py-1.5 rounded-lg text-xs" style={{ backgroundColor: 'rgba(212, 175, 55, 0.08)' }}>
        ...
        <section className="mt-12 p-6 rounded-2xl" style={{ backgroundColor: 'rgba(212, 175, 55, 0.05)', border: '1px solid rgba(212, 175, 55, 0.15)' }}>
          ...
          <div className="text-sm leading-relaxed space-y-2" style={{ color: '#A8B3C7' }}>
            ...
            <p>
              <strong style={{ color: '#F4F7FA' }}>Transparence :</strong> Notre historique public (<a href="/historique" style={{ color: '#D4AF37' }}>voir l'historique vérifié</a>) permet à chacun de vérifier nos performances réelles, gagnés ET perdus.
            </p>
          </div>
        </section>
