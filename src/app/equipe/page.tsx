...
const DESCRIPTION = "Équipe d'analystes BTTSPredict : profils et expertise en modélisation statistique football. 18+."
      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <nav aria-label="Fil d'Ariane" className="mb-8">
          <ol className="flex items-center gap-2 text-sm" style={{ color: '#A5ABC5' }}>
            ...
            <li style={{ color: '#F7F8FF' }} aria-current="page">Équipe</li>
          </ol>
        </nav>
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F7F8FF', fontFamily: 'Poppins, sans-serif' }}>
            Les experts derrière <span style={{ color: '#5146F5' }}>BTTSPredict</span>
          </h1>
            ...
            >
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-bold mb-1" style={{ color: '#F7F8FF', fontFamily: 'Poppins, sans-serif' }}>
                    {expert.name}
                  </h2>
                  <p className="text-sm mb-3" style={{ color: '#5146F5', fontWeight: 600 }}>
                    {expert.role}
                  </p>
                  <p className="text-sm leading-relaxed mb-4" style={{ color: '#A5ABC5' }}>
                    {expert.bio}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3 mb-4">
                    {Object.entries(expert.stats).map(([key, value]) => (
                      <div key={key} className="px-3 py-1.5 rounded-lg text-xs" style={{ backgroundColor: 'rgba(81, 70, 245, 0.08)' }}>
                        <span style={{ color: '#A5ABC5' }}>{key}: </span>
                        <span style={{ color: '#5146F5', fontWeight: 700 }}>{value}</span>
                      </div>
                    ))}
                  </div>
