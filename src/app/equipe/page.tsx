      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <nav aria-label="Fil d'Ariane" className="mb-8">
          <ol className="flex items-center gap-2 text-sm" style={{ color: '#9A9791' }}>
            ...
            <li style={{ color: '#F5F2ED' }} aria-current="page">Équipe</li>
          </ol>
        </nav>
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F5F2ED', fontFamily: 'Poppins, sans-serif' }}>
            Les experts derrière <span style={{ color: '#D8BA91' }}>BTTSPredict</span>
          </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-shrink-0 mx-auto sm:mx-0">
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, #D8BA91, #E5CDB0)',
                      color: '#090A0B',
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-bold mb-1" style={{ color: '#F5F2ED', fontFamily: 'Poppins, sans-serif' }}>
                    {expert.name}
                  </h2>
                  <p className="text-sm mb-3" style={{ color: '#D8BA91', fontWeight: 600 }}>
                    {expert.role}
                  </p>
                  <p className="text-sm leading-relaxed mb-4" style={{ color: '#9A9791' }}>
                    {expert.bio}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3 mb-4">
                    {Object.entries(expert.stats).map(([key, value]) => (
                      <div key={key} className="px-3 py-1.5 rounded-lg text-xs" style={{ backgroundColor: 'rgba(216, 186, 145, 0.08)' }}>
                        <span style={{ color: '#9A9791' }}>{key}: </span>
                        <span style={{ color: '#D8BA91', fontWeight: 700 }}>{value}</span>
                      </div>
                    ))}
                  </div>
        ...
        {/* Section confiance */}
        <section className="mt-12 p-6 rounded-2xl" style={{ backgroundColor: 'rgba(216, 186, 145, 0.05)', border: '1px solid rgba(216, 186, 145, 0.15)' }}>
          <h2 className="text-xl font-bold mb-3" style={{ color: '#F5F2ED', fontFamily: 'Poppins, sans-serif' }}>
            Pourquoi notre équipe inspire confiance ?
          </h2>
          <div className="text-sm leading-relaxed space-y-2" style={{ color: '#9A9791' }}>
            <p>
              <strong style={{ color: '#F5F2ED' }}>Expertise documentée :</strong> Chaque analyste possède une expertise spécifique documentée (AFCON, ligues européennes, value bets FIFA) et un parcours vérifiable sur LinkedIn et Twitter.
            </p>
            <p>
              <strong style={{ color: '#F5F2ED' }}>Contrôle humain :</strong> Contrairement aux plateformes entièrement automatisées, chaque pronostic VIP est validé manuellement par notre équipe avant publication. Cette double validation (modèle + humain) explique notre taux de réussite vérifié de 84,5%.
            </p>
            <p>
              <strong style={{ color: '#F5F2ED' }}>Transparence :</strong> Notre historique public (<a href="/historique" style={{ color: '#D8BA91' }}>voir l'historique vérifié</a>) permet à chacun de vérifier nos performances réelles, gagnés ET perdus.
            </p>
          </div>
        </section>
