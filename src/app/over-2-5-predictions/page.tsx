      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F4F7FA', fontFamily: 'Poppins, sans-serif' }}>
            Over 2.5 <span style={{ color: '#D4AF37' }}>Predictions</span>
          </h1>
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: '#1E2228', border: '1px solid rgba(244, 247, 250, 0.08)' }}>
          ...
          <div className="text-sm leading-relaxed space-y-3" style={{ color: '#A8B3C7' }}>
            ...
            <p>Pour voir nos pronostics Over 2.5 du jour, consultez notre <a href="/" style={{ color: '#D4AF37' }}>page d'accueil</a> ou notre <a href="/historique" style={{ color: '#D4AF37' }}>historique vérifié</a>.</p>
          </div>
        </section>
        ...
        {/* Résumé */}
        <section className="p-6 rounded-2xl" style={{ backgroundColor: 'rgba(212, 175, 55, 0.05)', border: '1px solid rgba(212, 175, 55, 0.15)' }}>
          <h2 className="text-lg font-bold mb-2" style={{ color: '#F4F7FA' }}>Résumé</h2>
          <p className="text-sm" style={{ color: '#A8B3C7' }}>
            Les pronostics Over 2.5 de BTTSPredict utilisent un modèle de Poisson calibré sur 50 000 matchs avec un taux de réussite vérifié de 84,5%. Notre méthodologie est <a href="/methodologie" style={{ color: '#D4AF37' }}>documentée publiquement</a> et notre historique est <a href="/historique" style={{ color: '#D4AF37' }}>vérifiable</a>. Aucun résultat n'est garanti.
          </p>
        </section>
