      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        <nav aria-label="Fil d'Ariane" className="mb-8">
          <ol className="flex items-center gap-2 text-sm" style={{ color: '#AAB7CC' }}>
            ...
            <li style={{ color: '#F8FAFC' }} aria-current="page">Over 2.5 Predictions</li>
          </ol>
        </nav>
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F8FAFC', fontFamily: 'Poppins, sans-serif' }}>
            Over 2.5 <span style={{ color: '#16C7A3' }}>Predictions</span>
          </h1>
        ...
        <section className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-10">
          {STATS.map((stat, i) => (
            <div key={i} className="text-center p-4 rounded-xl" style={{ backgroundColor: '#0F172A', border: '1px solid rgba(248, 250, 252, 0.08)' }}>
              <div className="text-2xl font-bold" style={{ color: '#16C7A3' }}>{stat.value}</div>
              <div className="text-[10px] mt-1 uppercase tracking-wider" style={{ color: '#AAB7CC' }}>{stat.label}</div>
            </div>
          ))}
        </section>
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: '#0F172A', border: '1px solid rgba(248, 250, 252, 0.08)' }}>
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F8FAFC', fontFamily: 'Poppins, sans-serif' }}>Comment nous analysons les matchs Over 2.5</h2>
          <div className="text-sm leading-relaxed space-y-3" style={{ color: '#AAB7CC' }}>
            ...
            <p>Pour voir nos pronostics Over 2.5 du jour, consultez notre <a href="/" style={{ color: '#16C7A3' }}>page d'accueil</a> ou notre <a href="/historique" style={{ color: '#16C7A3' }}>historique vérifié</a>.</p>
          </div>
        </section>

        {/* Tableau statistiques par ligue */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F8FAFC', fontFamily: 'Poppins, sans-serif' }}>Statistiques Over 2.5 par championnat</h2>
          <div className="overflow-x-auto rounded-xl" style={{ backgroundColor: '#0F172A', border: '1px solid rgba(248, 250, 252, 0.08)' }}>
            <table className="w-full text-xs">
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.08)' }}>
                  <th className="text-left py-3 px-3 font-semibold" style={{ color: '#AAB7CC' }}>Championnat</th>
                  <th className="text-right py-3 px-3 font-semibold" style={{ color: '#AAB7CC' }}>Pronostics</th>
                  <th className="text-right py-3 px-3 font-semibold" style={{ color: '#AAB7CC' }}>Réussite</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.04)' }}><td className="py-2 px-3" style={{ color: '#F8FAFC' }}>Bundesliga</td><td className="text-right py-2 px-3" style={{ color: '#AAB7CC' }}>12</td><td className="text-right py-2 px-3" style={{ color: '#16C7A3', fontWeight: 700 }}>91,7%</td></tr>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.04)' }}><td className="py-2 px-3" style={{ color: '#F8FAFC' }}>Eredivisie</td><td className="text-right py-2 px-3" style={{ color: '#AAB7CC' }}>10</td><td className="text-right py-2 px-3" style={{ color: '#16C7A3', fontWeight: 700 }}>90,0%</td></tr>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.04)' }}><td className="py-2 px-3" style={{ color: '#F8FAFC' }}>Premier League</td><td className="text-right py-2 px-3" style={{ color: '#AAB7CC' }}>15</td><td className="text-right py-2 px-3" style={{ color: '#16C7A3', fontWeight: 700 }}>86,7%</td></tr>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.04)' }}><td className="py-2 px-3" style={{ color: '#F8FAFC' }}>Ligue 1</td><td className="text-right py-2 px-3" style={{ color: '#AAB7CC' }}>10</td><td className="text-right py-2 px-3" style={{ color: '#16C7A3', fontWeight: 700 }}>80,0%</td></tr>
                <tr><td className="py-2 px-3" style={{ color: '#F8FAFC' }}>Serie A</td><td className="text-right py-2 px-3" style={{ color: '#AAB7CC' }}>11</td><td className="text-right py-2 px-3" style={{ color: '#16C7A3', fontWeight: 700 }}>81,8%</td></tr>
              </tbody>
            </table>
          </div>
        </section>
        ...
        {/* FAQ */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F8FAFC', fontFamily: 'Poppins, sans-serif' }}>FAQ Over 2.5 Predictions</h2>
        ...
        {/* Résumé */}
        <section className="p-6 rounded-2xl" style={{ backgroundColor: 'rgba(22, 199, 163, 0.05)', border: '1px solid rgba(22, 199, 163, 0.15)' }}>
          <h2 className="text-lg font-bold mb-2" style={{ color: '#F8FAFC' }}>Résumé</h2>
          <p className="text-sm" style={{ color: '#AAB7CC' }}>
            Les pronostics Over 2.5 de BTTSPredict utilisent un modèle de Poisson calibré sur 50 000 matchs avec un taux de réussite vérifié de 84,5%. Notre méthodologie est <a href="/methodologie" style={{ color: '#16C7A3' }}>documentée publiquement</a> et notre historique est <a href="/historique" style={{ color: '#16C7A3' }}>vérifiable</a>. Aucun résultat n'est garanti.
          </p>
        </section>
