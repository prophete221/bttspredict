...
export const metadata: Metadata = {
  ...
  description: "Pronostics BTTS et Over 2.5 du jour basés sur un modèle statistique Poisson. Sélections filtrées par ligues HIGH_BTTS et forme récente des équipes. 18+.",
  alternates: { canonical: 'https://bttspredict.com/pronostics' },
  robots: { index: true, follow: true },
  openGraph: {
    title: "Pronostics BTTS et Over 2.5 du jour — BTTSPredict",
    description: "Pronostics BTTS et Over 2.5 basés sur un modèle statistique Poisson. 18+. Aucun gain garanti.",
        ...
        <section className="max-w-6xl mx-auto px-4 pt-12 pb-6 sm:pt-16 sm:pb-8">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <p className="text-base sm:text-lg text-[#A5ABC5] leading-relaxed mb-3">
              Sélections du jour générées par le modèle statistique Poisson V3-Reliability, filtrées par ligues HIGH_BTTS et forme récente des équipes.
            </p>
