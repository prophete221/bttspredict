    ...
    <div className="min-h-screen bg-[#080B12] flex flex-col text-[#F7F4EE]">
      ...
      <main id="main-content" className="flex-1">
        <section className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="p-5 rounded-xl mb-6" style={{ backgroundColor: '#111722', border: '1px solid #3A4556' }}>
            ...
            <p className="text-sm text-[#9BA7B8] leading-relaxed mb-3">
              Les pronostics de demain sont disponibles sur la page <Link href="/btts/predictions/today" className="text-[#18A879] underline">Pronostics du jour</Link> dès qu'ils sont publiés par le moteur. La page est mise à jour automatiquement 4 fois par jour via GitHub Actions.
            </p>
          ...
          <p className="text-xs text-[#9BA7B8] mt-8 leading-relaxed">
