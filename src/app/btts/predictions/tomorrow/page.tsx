      ...
      <main id="main-content" className="flex-1">
        <section className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          <nav aria-label="Fil d'Ariane" className="text-xs text-[#9ca3af] mb-4">
            ...
            <span className="mx-1">/</span>
            <span className="text-[#9ca3af]">BTTS Tomorrow</span>
          </nav>
          ...
          <div className="p-5 rounded-xl mb-6" style={{ backgroundColor: '#1e1f20', border: '1px solid #2d2f31' }}>
            ...
            <p className="text-sm text-[#9ca3af] leading-relaxed mb-3">
              Les pronostics de demain sont disponibles sur la page <Link href="/pronostics" className="text-[#22c55e] underline">Pronostics du jour</Link> dès qu'ils sont publiés par le moteur. La page est mise à jour automatiquement 4 fois par jour via GitHub Actions.
            </p>
