      ...
      <main id="main-content" className="flex-1">
        <section className="max-w-5xl mx-auto px-4 pt-12 pb-6 sm:pt-16">
          <nav aria-label="Fil d'Ariane" className="text-xs text-[#9CA3AF] mb-4">
            ...
            <span className="mx-1">/</span>
            <span className="text-[#6B7280]">BTTS Today</span>
          </nav>
          ...
          <p className="text-base sm:text-lg text-[#6B7280] leading-relaxed mb-3 max-w-3xl mx-auto">
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <p className="text-sm text-[#6B7280] leading-relaxed">
            Pour comprendre en détail comment fonctionne l'analyse BTTS, consultez notre <Link href="/methodologie" className="text-[#121212] underline">méthodologie du moteur IA</Link>.
          </p>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/btts/statistics" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#121212]"
              style={{ backgroundColor: '#FFFFFF', border: '1px solid #E6E8EB' }}>
              <div className="text-sm font-bold text-[#111827]">Statistiques BTTS →</div>
              <div className="text-xs text-[#6B7280] mt-1">Taux historique par ligue</div>
            </Link>
            <Link href="/vip" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#121212]"
              style={{ backgroundColor: '#FFFFFF', border: '1px solid #E6E8EB' }}>
              <div className="text-sm font-bold text-[#111827]">Pronostics premium →</div>
              <div className="text-xs text-[#6B7280] mt-1">Programme VIP BTTSPredict</div>
            </Link>
          </div>
        </section>
      </main>
