      ...
      <main id="main-content" className="flex-1">
        <article className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <span className="inline-block px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider mb-4"
            style={{ backgroundColor: 'rgba(99, 214, 255, 0.12)', color: '#18A879', border: '1px solid rgba(99, 214, 255, 0.25)' }}>
            BTTS · Statistics
          </span>
          <h1 className="text-3xl sm:text-4xl font-bold mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Statistiques BTTS par ligue
          </h1>
          <p className="text-base text-[#9BA7B8] leading-relaxed mb-6">
              ...
              <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #3A4556' }}>
                    <th className="text-left py-3 px-4 font-bold text-[#9BA7B8]">Ligue</th>
                    <th className="text-center py-3 px-4 font-bold text-[#9BA7B8]">Taux BTTS</th>
                    <th className="text-center py-3 px-4 font-bold text-[#9BA7B8]">Buts/match</th>
                  </tr>
                </thead>
                <tbody>
                  {LEAGUE_STATS.map((row, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #3A4556' }}>
                      <td className="py-3 px-4 text-[#F7F4EE] font-medium">{row.league}</td>
                      <td className="text-center py-3 px-4 text-[#9BA7B8] font-mono text-xs">Données en préparation</td>
                      <td className="text-center py-3 px-4 text-[#9BA7B8] font-mono text-xs">Données en préparation</td>
                    </tr>
                  ))}
                </tbody>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-sm text-[#9BA7B8] leading-relaxed">
              <p>
                <strong className="text-[#F7F4EE]">Taux BTTS</strong> : pourcentage de matchs où les deux équipes ont marqué au moins un but. Les valeurs exactes par ligue seront affichées une fois une source vérifiable intégrée au build.
              </p>
              <p>
              ...
              <p>
                Ces statistiques ne garantissent aucun résultat futur. Elles servent uniquement à comprendre la logique de sélection des ligues par le moteur. Pour voir les pronostics actuels, consultez la page <Link href="/btts/predictions/today" className="text-[#18A879] underline">BTTS Predictions Today</Link>.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Link href="/historique" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#18A879]"
                style={{ backgroundColor: '#111722', border: '1px solid #3A4556' }}>
