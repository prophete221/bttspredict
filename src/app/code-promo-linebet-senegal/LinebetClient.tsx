...
const GOLD = '#5DD9A0'       // vert clair Linebet
    ...
    <>
      ...
      {toast && (
        <div
          ...
          style={{
            backgroundColor: '#5DD9A0',
            color: BG_DARK,
            border: '1.5px solid #5DD9A0',
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{
                  backgroundColor: copied ? '#5DD9A0' : `${GOLD}1A`,
                  border: `1px solid ${copied ? '#5DD9A0' : GOLD}`,
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <button
                ...
                style={{
                  backgroundColor: copied ? '#5DD9A0' : GOLD,
      ...
      <section className="pb-10">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${GOLD}33`, backgroundColor: '#102333' }}>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <details key={item.q} className="rounded-2xl p-4" style={{ backgroundColor: '#102333', border: `1px solid ${GOLD}22` }}>
      ...
      <section className="pb-10">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl p-5 text-center" style={{ backgroundColor: '#102333', border: `1px solid ${GOLD}22` }}>
