      ...
      <main id="main-content" className="flex-1 relative z-10">
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <header className="mb-10">
            <span className="text-[11px] font-semibold uppercase tracking-wider px-2.5 py-0.5 rounded-md border bg-or/15 text-or border-or/30">
              FIFA
            </span>
            <h1
          ...
          <div className="prose-custom space-y-8">
            ...
            <section>
              ...
              <ul className="space-y-3 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Ratings des équipes</strong> — Chaque équipe FIFA a un rating
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Marge du bookmaker</strong> — Linebet applique une marge
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Flux de volume</strong> — Les marchés FIFA reçoivent moins
            ...
            <section>
              ...
              <ol className="space-y-4 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5 text-lg">1.</span>
                  <span>
                    <strong className="text-papier">Collecter les données</strong> — Enregistrez les résultats de tous
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5 text-lg">2.</span>
                  <span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5 text-lg">3.</span>
                  <span>
                    <strong className="text-papier">Identifier les patterns</strong> — Certains patterns FIFA sont
                ...
                <li className="flex items-start gap-3">
                  <span className="text-or font-bold mt-0.5 text-lg">4.</span>
                  <span>
            ...
            <section>
              ...
              <ol className="space-y-3 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Limitez le nombre de paris par heure</strong> — Maximum 4 paris
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Appliquez des mises encore plus faibles</strong> — Sur le marché
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Ne pariez jamais en « chase »</strong> — Après une perte, attendez
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Diversifiez les marchés</strong> — Ne vous limitez pas à un seul
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Surveillez les mises à jour FIFA</strong> — Quand EA Sports
            ...
            {/* CTA */}
            <section className="mt-12 p-6 sm:p-8 rounded-xl bg-panel/50 border border-or/30 text-center">
              <h2
