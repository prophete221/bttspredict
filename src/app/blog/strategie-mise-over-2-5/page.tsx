            ...
            <section>
              ...
              <div className="grid gap-3 mt-3 sm:grid-cols-2">
                <div className="p-3 rounded-lg bg-panel/30 border border-edge/30">
                  ...
                  <p className="text-gray-400 text-xs">85% de matchs Over 2,5 (toutes compétitions)</p>
                </div>
                <div className="p-3 rounded-lg bg-panel/30 border border-edge/30">
                  <p className="text-white font-semibold text-sm">PSV Eindhoven 🇳🇱</p>
                  <p className="text-gray-400 text-xs">82% de matchs Over 2,5 en Eredivisie</p>
                </div>
                <div className="p-3 rounded-lg bg-panel/30 border border-edge/30">
                  <p className="text-white font-semibold text-sm">Atalanta Bergame 🇮🇹</p>
                  <p className="text-gray-400 text-xs">78% de matchs Over 2,5 en Serie A</p>
                </div>
                <div className="p-3 rounded-lg bg-panel/30 border border-edge/30">
                  <p className="text-white font-semibold text-sm">Brentford 🏴󠁧󠁢󠁥󠁮󠁧󠁿</p>
                  <p className="text-gray-400 text-xs">75% de matchs Over 2,5 en Premier League</p>
                </div>
              </div>
            </section>
