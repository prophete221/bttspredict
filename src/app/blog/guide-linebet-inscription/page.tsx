      ...
      <main id="main-content" className="flex-1 relative z-10">
        ...
        <nav aria-label="Fil d'Ariane" className="max-w-3xl mx-auto px-4 sm:px-6 pt-6">
          <ol className="flex items-center gap-2 text-sm text-cendre flex-wrap">
            ...
            <li aria-hidden="true" className="text-cendre">/</li>
            <li><span className="text-cendre" aria-current="page">Guide Linebet</span></li>
          </ol>
        </nav>
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <div className="prose-custom space-y-8">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-3 mt-4 text-cendre leading-relaxed">
                <li>
                  <strong className="text-papier">Accédez au site officiel</strong> — Rendez-vous sur Linebet via notre
                ...
                <li>
                  <strong className="text-papier">Cliquez sur « Inscription »</strong> — Le bouton est visible en haut à
                ...
                <li>
                  <strong className="text-papier">Remplissez vos informations</strong> — Indiquez votre numéro de téléphone
                ...
                <li>
                  <strong className="text-papier">Saisissez le code promo VISION221</strong> — Dans le champ « Code promo »,
                ...
                <li>
                  <strong className="text-papier">Validez votre compte</strong> — Un code de confirmation sera envoyé par SMS
            ...
            <section>
              ...
              <div className="grid gap-4 mt-4 sm:grid-cols-2">
                <div className="card p-4">
                  <h3 className="text-papier font-bold text-sm mb-2">Mobile Money & Orange Money</h3>
                ...
                <div className="card p-4">
                  <h3 className="text-papier font-bold text-sm mb-2">Crypto-monnaies</h3>
                  <p className="text-cendre text-sm leading-relaxed">
                ...
                <div className="card p-4">
                  <h3 className="text-papier font-bold text-sm mb-2">Carte bancaire / Virement</h3>
                  <p className="text-cendre text-sm leading-relaxed">
                ...
                <div className="card p-4">
                  <h3 className="text-papier font-bold text-sm mb-2">Agents locaux</h3>
                  <p className="text-cendre text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-3 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Section « Sports »</strong> — Accédez à tous les sports disponibles,
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Section « Live »</strong> — Pariez en direct sur les matchs en cours.
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Coupon de paris</strong> — Ajoutez vos sélections au coupon, choisissez
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald font-bold mt-0.5">▸</span>
                  <span><strong className="text-papier">Mon compte</strong> — Gérez vos dépôts, retraits, historique de paris
            ...
            <section>
              ...
              <div className="mt-4 p-5 rounded-lg bg-panel/50 border border-edge/50">
                <h3 className="text-papier font-bold mb-3">Conditions à retenir :</h3>
                <ul className="space-y-2 text-sm text-cendre leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-3 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Choisissez la bonne devise</strong> — Optez pour le Franc CFA (XOF ou XAF)
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Privilégiez le Mobile Money</strong> — C&apos;est la méthode la plus rapide
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Gérez votre bankroll en FCFA</strong> — Fixez-vous un budget mensuel clair
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-papier">Effectuez la vérification KYC dès l&apos;inscription</strong> — Envoyez
            ...
            <section>
              ...
              <ul className="space-y-2 mt-4 text-cendre leading-relaxed">
                <li className="flex items-start gap-2">
                  <span className="text-emerald">▸</span>
                  <span><strong className="text-papier">Mobile Money</strong> — Retrait en 5 à 30 minutes. Montant minimum :
                  1 000 FCFA. Montant maximum par transaction : 500 000 FCFA selon l&apos;opérateur.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald">▸</span>
                  <span><strong className="text-papier">Crypto</strong> — Retrait en 10 à 60 minutes selon la blockchain.
                  Idéal pour les montants importants sans limite de plafond.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald">▸</span>
                  <span><strong className="text-papier">Virement bancaire</strong> — Délai de 1 à 5 jours ouvrés.
