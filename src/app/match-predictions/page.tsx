      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 w-full">
        <nav aria-label="Fil d'Ariane" className="mb-8">
          <ol className="flex items-center gap-2 text-sm" style={{ color: '#8A8494' }}>
            ...
            <li style={{ color: '#F4F1EA' }} aria-current="page">Match Predictions</li>
          </ol>
        </nav>
        ...
        <header className="mb-10 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mt-3 mb-4" style={{ color: '#F4F1EA', fontFamily: 'Poppins, sans-serif' }}>
            Match <span style={{ color: '#C9A227' }}>Predictions</span>
          </h1>
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: '#0F1219', border: '1px solid rgba(244, 241, 234, 0.08)' }}>
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F4F1EA', fontFamily: 'Poppins, sans-serif' }}>Analyse détaillée par match</h2>
          <div className="text-sm leading-relaxed space-y-3" style={{ color: '#8A8494' }}>
            ...
            <p>Pour voir nos analyses de matchs, consultez notre <a href="/" style={{ color: '#C9A227' }}>page d'accueil</a> ou notre <a href="/historique" style={{ color: '#C9A227' }}>historique vérifié</a>.</p>
          </div>
        </section>
        ...
        <section className="mb-8 p-6 rounded-2xl" style={{ backgroundColor: 'rgba(201, 162, 39, 0.05)', border: '1px solid rgba(201, 162, 39, 0.15)' }}>
          ...
          <p className="text-sm" style={{ color: '#8A8494' }}>
            BTTSPredict analyse chaque match sur 200+ variables avec un taux de réussite vérifié de 84,5%. <a href="/methodologie" style={{ color: '#C9A227' }}>Méthodologie</a> documentée, <a href="/historique" style={{ color: '#C9A227' }}>historique</a> vérifiable. 18+ — Jeu responsable.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4" style={{ color: '#F4F1EA', fontFamily: 'Poppins, sans-serif' }}>FAQ Match Predictions</h2>
