  ...
  return (
    <div className="min-h-screen bg-[#070A14] flex flex-col text-[#F1F5F9]">
      ...
      <main id="main-content" className="flex-1">
        {/* Breadcrumb */}
        <nav aria-label="Fil d'Ariane" className="max-w-4xl mx-auto px-4 pt-6 pb-2 text-xs text-[#64748B]">
        ...
        <article className="max-w-4xl mx-auto px-4 py-8">
          ...
          <header className="mb-8">
            <div className="flex items-center justify-center gap-4 sm:gap-8 mb-4">
              ...
              <div className="text-2xl font-bold text-[#64748B]">vs</div>
              <div className="flex flex-col items-center gap-2 flex-1">
                {awayLogo && (
                  // eslint-disable-next-line @next/next/no-img-element
            ...
            {finalScore && (
              <div className="text-center mb-2">
                <span className="inline-block px-4 py-2 rounded-xl text-lg font-bold" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {predictions.map((p, i) => {
                ...
                const color = isBtts ? '#10B981' : isOver ? '#5DFDCB' : '#94A3B8'
                ...
                return (
                  <div key={i} className="p-5 rounded-2xl" style={{ backgroundColor: '#111827', border: `1px solid ${color}40` }}>
                    ...
                    <div className="w-full h-1.5 rounded-full mb-3" style={{ backgroundColor: '#111827' }}>
                      <div className="h-full rounded-full" style={{ width: `${probaPct}%`, backgroundColor: color }} />
                    </div>

                    <div className="text-xs text-[#64748B] mb-2">Confiance : {p.confidence}%</div>
                    ...
                    {isPending && (
                      <div className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-bold" style={{ backgroundColor: 'rgba(165, 171, 197, 0.15)', color: '#94A3B8' }}>
                        ⏳ En attente
                      </div>
                    )}
                  </div>
            ...
            <p className="text-xs text-[#64748B] mt-4 leading-relaxed text-center">
            ...
            <div className="p-4 rounded-xl" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <div className="text-xs text-[#64748B] uppercase">Gagnés</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#EF4444]">{lost}</div>
                  <div className="text-xs text-[#64748B] uppercase">Perdus</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#94A3B8]">{pending}</div>
                  <div className="text-xs text-[#64748B] uppercase">En attente</div>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link href="/pronostics" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37]"
                style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <div className="text-sm font-bold text-[#F1F5F9] mb-1">Voir les pronostics du jour →</div>
              ...
              <Link href="/vip" className="block p-4 rounded-xl transition-all hover:scale-[1.01] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37]"
                style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <div className="text-sm font-bold text-[#F1F5F9] mb-1">Pronostics premium →</div>
