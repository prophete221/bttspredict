        ...
        <article className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <h3 className="text-base font-bold mb-2 text-[#F1F5F9]">ESPN</h3>
              ...
              <div className="p-4 rounded-xl" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <h3 className="text-base font-bold mb-2 text-[#F1F5F9]">TheSportsDB</h3>
                <p className="text-xs text-[#94A3B8] leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(124, 58, 237, 0.15)' }}>
                  <span className="text-xs font-bold text-[#10B981]">BT</span>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#F1F5F9] mb-1">BTTS (Both Teams To Score)</h3>
                  <p className="text-xs text-[#94A3B8] leading-relaxed">
              ...
              <div className="p-4 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(93, 253, 203, 0.15)' }}>
                  <span className="text-xs font-bold text-[#10B981]">O2</span>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#F1F5F9] mb-1">Over 2.5 goals</h3>
                  <p className="text-xs text-[#94A3B8] leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-sm text-[#94A3B8]">
              <li className="flex items-start gap-2"><span className="text-[#10B981]">✓</span> <span>Vérification automatique des critères de publication avant chaque pronostic.</span></li>
              <li className="flex items-start gap-2"><span className="text-[#10B981]">✓</span> <span>Nombre limité de pronostics publiés par jour (sélection des meilleures probabilités).</span></li>
              <li className="flex items-start gap-2"><span className="text-[#10B981]">✓</span> <span>Archive quotidienne horodatée et immuable (un pronostic publié n'est jamais modifié rétroactivement).</span></li>
              <li className="flex items-start gap-2"><span className="text-[#10B981]">✓</span> <span>Vérification post-match via les sources publiques.</span></li>
              <li className="flex items-start gap-2"><span className="text-[#10B981]">✓</span> <span>Gestion automatique des données manquantes (voir section 7).</span></li>
            </ul>
            <p className="text-xs text-[#64748B] mt-3 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-[#94A3B8] leading-relaxed mb-3">
              Une nouvelle période de suivi public a été lancée le <strong className="text-[#F1F5F9]">8 août 2026</strong>. Tous les pronostics publiés à partir de cette date sont :
            </p>
            <ul className="space-y-2 text-sm text-[#94A3B8]">
          ...
          <section className="pt-8 border-t border-[#1F2937]">
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <a href="/jouer-responsable" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-[10px] text-sm font-bold transition-all"
                style={{ backgroundColor: 'transparent', color: '#EF4444', border: '1px solid rgba(255, 113, 133, 0.3)' }}>
                Jouer responsable →
              </a>
            </div>
          </section>
