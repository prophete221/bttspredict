      ...
      <main id="main-content" className="flex-1">
        <article className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
          <header className="mb-10">
            ...
            <p className="text-base text-[#B7C7D9] leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-[#B7C7D9] leading-relaxed mb-4">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl" style={{ backgroundColor: '#0D1B2A', border: '1px solid #29445F' }}>
                <h3 className="text-base font-bold mb-2 text-[#F4F8FC]">ESPN</h3>
              ...
              <div className="p-4 rounded-xl" style={{ backgroundColor: '#0D1B2A', border: '1px solid #29445F' }}>
                <h3 className="text-base font-bold mb-2 text-[#F4F8FC]">TheSportsDB</h3>
                <p className="text-xs text-[#B7C7D9] leading-relaxed">
            ...
            <p className="text-xs text-[#B7C7D9] mt-4 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#0D1B2A', border: '1px solid #29445F' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(99, 214, 255, 0.15)' }}>
                  <span className="text-xs font-bold text-[#2176FF]">BT</span>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#F4F8FC] mb-1">BTTS (Both Teams To Score)</h3>
                  <p className="text-xs text-[#B7C7D9] leading-relaxed">
              ...
              <div className="p-4 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#0D1B2A', border: '1px solid #29445F' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(99, 214, 255, 0.15)' }}>
                  <span className="text-xs font-bold text-[#2176FF]">O2</span>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#F4F8FC] mb-1">Over 2.5 goals</h3>
                  <p className="text-xs text-[#B7C7D9] leading-relaxed">
            ...
            <p className="text-xs text-[#B7C7D9] mt-3 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-sm text-[#B7C7D9]">
              <li className="flex items-start gap-2"><span className="text-[#2176FF]">✓</span> <span>Vérification automatique des critères de publication avant chaque pronostic.</span></li>
              <li className="flex items-start gap-2"><span className="text-[#2176FF]">✓</span> <span>Nombre limité de pronostics publiés par jour (sélection des meilleures probabilités).</span></li>
              <li className="flex items-start gap-2"><span className="text-[#2176FF]">✓</span> <span>Archive quotidienne horodatée et immuable (un pronostic publié n'est jamais modifié rétroactivement).</span></li>
              <li className="flex items-start gap-2"><span className="text-[#2176FF]">✓</span> <span>Vérification post-match via les sources publiques.</span></li>
              <li className="flex items-start gap-2"><span className="text-[#2176FF]">✓</span> <span>Gestion automatique des données manquantes (voir section 7).</span></li>
            </ul>
            <p className="text-xs text-[#B7C7D9] mt-3 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-[#B7C7D9] leading-relaxed mt-3">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-[#B7C7D9] leading-relaxed mb-3">
              Une nouvelle période de suivi public a été lancée le <strong className="text-[#F4F8FC]">8 août 2026</strong>. Tous les pronostics publiés à partir de cette date sont :
            </p>
            <ul className="space-y-2 text-sm text-[#B7C7D9]">
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-xl" style={{ backgroundColor: 'rgba(199, 244, 100, 0.06)', border: '1px solid rgba(199, 244, 100, 0.2)' }}>
              ...
              <p className="text-sm text-[#B7C7D9] leading-relaxed">
                <strong className="text-[#16A36A]">Aucun résultat futur n'est garanti.</strong> Les paris sportifs comportent un risque de perte. Ne pariez jamais plus que ce que vous pouvez vous permettre de perdre. 18+.
              </p>
            </div>
          </section>
          ...
          <section className="pt-8 border-t border-[#29445F]">
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <a href="/jouer-responsable" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-[10px] text-sm font-bold transition-all"
                style={{ backgroundColor: 'transparent', color: '#D94B4B', border: '1px solid rgba(255, 122, 122, 0.3)' }}>
                Jouer responsable →
              </a>
            </div>
          </section>
