...
export default function SportMarquee() {
  ...
  return (
    <div className="relative overflow-hidden py-3 border-y" style={{ borderColor: 'rgba(168, 179, 199, 0.3)', backgroundColor: 'rgba(13, 15, 18, 0.5)' }}>
      {/* Fade edges */}
      <div
        className="absolute left-0 top-0 bottom-0 z-10 w-16 sm:w-24 pointer-events-none"
        style={{ background: 'linear-gradient(90deg, #0D0F12, transparent)' }}
      />
      <div
        className="absolute right-0 top-0 bottom-0 z-10 w-16 sm:w-24 pointer-events-none"
        style={{ background: 'linear-gradient(270deg, #0D0F12, transparent)' }}
      />
          ...
          >
            <img
              ...
              onMouseEnter={(e) => {
                ...
                ;(e.currentTarget.style as any).dropShadow = '0 0 12px rgba(212, 175, 55, 0.5)'
              }}
              onMouseLeave={(e) => {
