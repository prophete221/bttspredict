...
export default function SportMarquee() {
  ...
  return (
    <div className="relative overflow-hidden py-3 border-y" style={{ borderColor: 'rgba(51, 65, 85, 0.3)', backgroundColor: 'rgba(11, 17, 32, 0.5)' }}>
      {/* Fade edges */}
      <div
          ...
          >
            <img
              ...
              onMouseEnter={(e) => {
                ...
                ;(e.currentTarget.style as any).dropShadow = '0 0 12px rgba(0, 212, 255, 0.5)'
              }}
              onMouseLeave={(e) => {
