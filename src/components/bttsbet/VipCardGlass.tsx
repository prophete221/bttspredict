 ...
 *
 * Style : Verre dépoli (translucidité + backdrop-filter blur) sur fond sombre #0D202D
 * Accents : Émeraude vif #E6A24C + Or Champagne #E6A24C
 ...
 * 2. Corps : Nom utilisateur (Blanc cassé #F3F7F5) + Liste avantages (Gris #B4C4CC) avec puces émeraude
      ...
      <div className="vip-glass-header">
        ...
        <div className="vip-glass-logo">
          <div className="vip-glass-logo-icon">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#07131D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M3 3v18h18" />
    ...
    <section id="vip-glass-cards" className="py-12 sm:py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-3" style={{ color: '#F3F7F5', fontFamily: 'Poppins, sans-serif' }}>
            Choisis ton <span style={{ color: '#E6A24C' }}>niveau VIP</span>
          </h2>
          <p className="text-sm max-w-md mx-auto" style={{ color: '#B4C4CC' }}>
