...
export default function GlobalReach() {
  return (
    <section id="global-reach" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(15, 19, 22, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {PANAFRICAN_PRESENCE.map((item, i) => (
              ...
              >
                ...
                <div className="text-xs font-bold" style={{ color: '#E0C191' }}>{item.users}</div>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(224, 193, 145, 0.05), rgba(224, 193, 145, 0.05))',
