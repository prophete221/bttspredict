      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          {GLOBAL_STATS.map((stat, i) => (
            ...
            >
              <div className="text-2xl font-bold" style={{ color: '#18A879' }}>{stat.value}</div>
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {PANAFRICAN_PRESENCE.map((item, i) => (
              ...
              >
                ...
                <div className="text-xs font-bold" style={{ color: '#18A879' }}>{item.users}</div>
              </div>
            ))}
          </div>
        </motion.div>
