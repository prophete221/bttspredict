      ...
      {TABS.map(tab => {
        ...
        return (
          <a
            key={tab.id}
            href={tab.href}
            className="flex-1 flex flex-col items-center justify-center gap-1 transition-colors duration-200 relative focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C7F464] focus-visible:ring-inset"
            style={{
          ...
          >
            ...
            <span
              ...
              style={{ color: isActive ? '#C7F464' : '#B5C4C9' }}
            >
              {tab.label}
            </span>
          </a>
