      ...
      {TABS.map(tab => {
        ...
        return (
          <a
            key={tab.id}
            href={tab.href}
            className="flex-1 flex flex-col items-center justify-center gap-1 transition-colors duration-200 relative focus:outline-none focus-visible:ring-2 focus-visible:ring-[#18A879] focus-visible:ring-inset"
            style={{
              color: isActive ? '#18A879' : '#9BA7B8',
              minHeight: '52px',
          ...
          >
            ...
            <span
              ...
              style={{ color: isActive ? '#18A879' : '#9BA7B8' }}
            >
              {tab.label}
            </span>
          </a>
