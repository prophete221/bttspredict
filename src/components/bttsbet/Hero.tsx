 ...
 *   CTA primaire: "Voir les pronos du jour" #7FA2C6
 *   CTA secondaire: "Explorer le dataset open-source" outline
 * Background: #0B1220 avec 2 blobs blur Indigo et Cyan + grille subtile
    ...
    >
      ...
      <div className="relative z-10 max-w-[440px] mx-auto px-4 flex flex-col gap-5">
        ...
        >
          ...
          {/* ═══ H2 ═══ */}
          <p className="mt-3 text-[13px] leading-[1.6]" style={{ color: '#C2CCD8', maxWidth: '380px' }}>
        ...
        >
          ...
          <motion.button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#7FA2C6'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = '#7FA2C6'
            }}
        ...
        <motion.div
          ...
          className="text-center text-[10px] text-[#C2CCD8]"
        >
