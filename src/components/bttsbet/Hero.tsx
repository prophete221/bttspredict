 ...
 *   CTA primaire: "Voir les pronos du jour" #18A879
    ...
    >
      ...
      <div className="relative z-10 max-w-[440px] mx-auto px-4 flex flex-col gap-5">
        ...
        >
          ...
          {/* ═══ H2 ═══ */}
          <p className="mt-3 text-[13px] leading-[1.6]" style={{ color: '#9BA7B8', maxWidth: '380px' }}>
        ...
        >
          ...
          <motion.button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#18A879'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = '#18A879'
            }}
        ...
        <motion.div
          ...
          className="text-center text-[10px] text-[#9BA7B8]"
        >
