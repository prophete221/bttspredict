...
const C = {
  ...
  green:        '#18E0B5',
  greenLight:   '#18E0B5',
  greenPale:    'rgba(24, 224, 181, 0.12)',
  grayDark:     '#09141D',
  grayMid:      '#9BB8BD',
  grayLight:    '#F1F8F5',
  white:        '#F1F8F5',
 ...
 * - Fond : dégradé vert foncé #5AF2A6 → noir #09141D
 * - H1 : "N°1 mondial des prédictions BTTS et Over 2.5" en blanc
 * - Badge : 84,5% vérifié en fond vert secondaire #18E0B5
 * - CTA principal : vert #18E0B5
...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{
        background: `linear-gradient(180deg, #0D2029 0%, #09141D 100%)`,
        paddingTop: '40px',
        paddingBottom: '40px',
      }}
    >
      <div className="relative z-10 max-w-[440px] mx-auto px-4 flex flex-col gap-5">
        ...
        {/* ═══ BADGE PREUVE — 84,5% vérifié (vert secondaire #18E0B5) ═══ */}
        <motion.div
        ...
        >
          {/* CTA principal : Voir les pronostics d'aujourd'hui (vert #18E0B5) */}
          <motion.button
        ...
        {/* ═══ MINI-TEXTE PORTÉE MONDIALE (gris moyen #9BB8BD) ═══ */}
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <span
            ...
            style={{ backgroundColor: 'rgba(24, 224, 181, 0.08)', color: '#18E0B5', border: '1px solid rgba(24, 224, 181, 0.15)' }}
          >
            🔒 SSL Sécurisé
          </span>
          <span
          ...
          <a
            ...
            style={{ backgroundColor: 'rgba(24, 224, 181, 0.1)', color: '#18E0B5', border: '1px solid rgba(24, 224, 181, 0.2)' }}
          >
            18+ | Jeu responsable
          </a>
        </motion.div>
