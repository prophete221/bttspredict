        ...
        >
          ...
          <div className="flex items-center gap-2 mb-3">
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#9BA7B8' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[10px]" style={{ backgroundColor: '#9CC4F4', color: '#080B12' }}>1</span>
              Inscris-toi
            </div>
            <span style={{ color: '#3A4556' }}>→</span>
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#9BA7B8' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[10px]" style={{ backgroundColor: '#9CC4F4', color: '#080B12' }}>2</span>
              Dépôt 3 000 / 6 000 / 12 000 XOF
            </div>
            <span style={{ color: '#3A4556' }}>→</span>
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#9BA7B8' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[10px]" style={{ backgroundColor: '#9CC4F4', color: '#080B12' }}>3</span>
              VIP activé
            </div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <a
              ...
              style={{ backgroundColor: 'rgba(199, 244, 100, 0.15)', border: '1px solid #9CC4F4', color: '#9CC4F4' }}
            >
              WhatsApp
            </a>
          </div>
          ...
          <div className="mt-3 text-center">
            ...
            <span className="font-mono font-bold text-[11px]" style={{ color: '#9CC4F4' }}>{SITE.promoCode}</span>
          </div>
        </div>
      </div>
    </section>
