    ...
    <section id="vip-card-widget" className="py-6 px-4" style={{ backgroundColor: '#0D0F12' }}>
      <div className="max-w-2xl mx-auto">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(22, 27, 34, 0.9), rgba(45, 91, 255, 0.08))',
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-3">
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#A8B3C7' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[8px]" style={{ backgroundColor: '#2D5BFF', color: '#0D0F12' }}>1</span>
              Inscris-toi
            </div>
            <span style={{ color: '#6E7681' }}>→</span>
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#A8B3C7' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[8px]" style={{ backgroundColor: '#2D5BFF', color: '#0D0F12' }}>2</span>
              Dépôt 3000 XOF
            </div>
            <span style={{ color: '#6E7681' }}>→</span>
            <div className="flex items-center gap-1 text-[9px]" style={{ color: '#A8B3C7' }}>
              <span className="w-5 h-5 rounded-full flex items-center justify-center font-bold text-[8px]" style={{ backgroundColor: '#2D5BFF', color: '#0D0F12' }}>3</span>
              VIP activé
            </div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <a
              ...
              style={{ backgroundColor: 'rgba(45, 91, 255, 0.15)', border: '1px solid #2D5BFF', color: '#2D5BFF' }}
            >
              WhatsApp
            </a>
          </div>
