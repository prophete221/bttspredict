        ...
        >
          <div
            ...
            style={{
              ...
              borderTop: '1px solid rgba(0, 196, 154, 0.2)',
          ...
          >
            ...
            <button
              ...
              style={{
                backgroundColor: copied ? 'rgba(0, 196, 154, 0.12)' : '#161B22',
                border: '1px solid ' + (copied ? 'rgba(0, 196, 154, 0.3)' : 'rgba(255, 255, 255, 0.12)'),
              }}
              aria-label="Copier le code promo VISION221"
              data-cta="sticky-copy"
            >
              {copied ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00C49A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
              ) : (
              ...
              <span className="font-mono text-[13px] font-bold" style={{ color: copied ? '#00C49A' : '#F2F6FA' }}>
