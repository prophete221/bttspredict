        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{
                backgroundColor: copied ? 'rgba(0, 184, 217, 0.12)' : '#2D3748',
                border: '1px solid ' + (copied ? 'rgba(0, 184, 217, 0.3)' : 'rgba(255, 255, 255, 0.12)'),
              }}
              aria-label="Copier le code promo VISION221"
              data-cta="sticky-copy"
            >
              {copied ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00B8D9" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
              ) : (
              ...
              <span className="font-mono text-[13px] font-bold" style={{ color: copied ? '#00B8D9' : '#F2F6FA' }}>
