        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{
                backgroundColor: copied ? 'rgba(199, 244, 100, 0.12)' : '#0D1B2A',
            ...
            >
              {copied ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
              ) : (
              ...
              <span className="font-mono text-[13px] font-bold" style={{ color: copied ? '#16A36A' : '#F4F8FC' }}>
