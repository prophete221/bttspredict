  ...
  return (
    <nav
      ...
      style={{
        ...
        borderTop: '1px solid rgba(45, 91, 255, 0.45)',
        // Halo néon cyan + violet qui « remonte » depuis le menu
        boxShadow:
          '0 -6px 24px rgba(45, 91, 255, 0.28), 0 -2px 12px rgba(0, 212, 245, 0.20), inset 0 1px 0 rgba(45, 91, 255, 0.18)',
        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? '#2D5BFF' : 'rgba(220, 230, 245, 0.65)',
              minHeight: '48px',
              textShadow: isActive
                ? '0 0 12px rgba(45, 91, 255, 0.85), 0 0 4px rgba(45, 91, 255, 0.6)'
                : 'none',
              filter: isActive
                ? 'drop-shadow(0 0 6px rgba(45, 91, 255, 0.75))'
                : 'none',
            }}
          ...
          >
            ...
            {isActive && (
              <motion.span
                ...
                style={{
                  ...
                  height: '3px',
                  borderRadius: '2px',
                  background: 'linear-gradient(90deg, #2D5BFF 0%, #4E78FF 100%)',
                  boxShadow: '0 0 12px rgba(45, 91, 255, 0.9), 0 0 6px rgba(0, 212, 245, 0.6)',
                }}
            ...
            <span
              ...
              style={{
                color: isActive ? '#2D5BFF' : 'rgba(200, 215, 235, 0.7)',
              }}
            >
              {tab.label}
            </span>
