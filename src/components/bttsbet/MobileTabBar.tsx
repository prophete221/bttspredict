  ...
  return (
    <nav
      ...
      style={{
        ...
        borderTop: '1px solid rgba(22, 163, 74, 0.45)',
        // Halo néon cyan + violet qui « remonte » depuis le menu
        boxShadow:
          '0 -6px 24px rgba(22, 163, 74, 0.28), 0 -2px 12px rgba(34, 197, 94, 0.20), inset 0 1px 0 rgba(22, 163, 74, 0.18)',
        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? '#16A34A' : 'rgba(220, 230, 245, 0.65)',
              minHeight: '48px',
              textShadow: isActive
                ? '0 0 12px rgba(22, 163, 74, 0.85), 0 0 4px rgba(22, 163, 74, 0.6)'
                : 'none',
              filter: isActive
                ? 'drop-shadow(0 0 6px rgba(22, 163, 74, 0.75))'
                : 'none',
            }}
          ...
          >
            ...
            {isActive && (
              <motion.span
                ...
                style={{
                  ...
                  boxShadow: '0 0 12px rgba(22, 163, 74, 0.9), 0 0 6px rgba(34, 197, 94, 0.6)',
                }}
            ...
            <span
              ...
              style={{
                color: isActive ? '#16A34A' : 'rgba(200, 215, 235, 0.7)',
              }}
            >
              {tab.label}
            </span>
