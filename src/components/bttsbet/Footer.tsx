...
export default function Footer() {
  ...
  return (
    <>
      <footer ref={ref} id="faq" className="border-t pt-10 pb-20 sm:pb-8 px-4" style={{ borderColor: '#2D5BFF', backgroundColor: '#0D0F12' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate={isVisible ? 'visible' : 'hidden'} className="mb-6">
            <div className="text-center mb-3">
              <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#2D5BFF]">Ils utilisent BTTSPredict</span>
            </div>
              ...
              {TESTIMONIALS.slice(0, 3).map((t) => (
                <motion.div key={t.name + t.city} variants={staggerChildFadeUp} className="rounded-xl p-4" style={{ backgroundColor: '#1E2228', border: '1px solid rgba(244, 247, 250, 0.08)' }}>
                  <div className="flex items-center gap-2.5 mb-2.5">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(45, 91, 255,0.1)', color: '#2D5BFF' }}>
                      {t.name.charAt(0)}
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            {[
              ...
              <a key={link.label} href={link.href} className="text-center text-[10px] text-[#A8B3C7] hover:text-[#2D5BFF] transition-colors py-2">
                {link.label}
              </a>
            ))}
          </div>
          ...
          <div className="rounded-xl p-4 mb-3" style={{ backgroundColor: '#1E2228' }}>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[#2D5BFF] font-extrabold text-xs">18+</span>
