  ...
  return (
    <>
      ...
      <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer"
        className="v31-shake fixed bottom-20 sm:bottom-6 right-6 z-50 w-11 h-11 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg shadow-green-500/20 transition-all hover:scale-110 border border-green-400/30"
