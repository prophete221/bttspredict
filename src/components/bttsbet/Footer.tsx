...
export default function Footer() {
  ...
  return (
    <>
      <footer ref={ref} id="faq" className="border-t pt-10 pb-20 sm:pb-8 px-4" style={{ borderColor: '#10B981', backgroundColor: '#0F172A' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <div initial="hidden" className="mb-6">
            <div className="text-center mb-3">
              <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#10B981]">Transparence</span>
            </div>
            <div className="p-4 rounded-xl text-center" style={{ backgroundColor: '#1E293B', border: '1px solid rgba(242, 247, 245, 0.08)' }}>
              <p className="text-[11px] text-[#94A3B8] leading-relaxed">
                BTTSPredict ne publie pas de témoignages clients. Notre engagement de transparence repose sur
                un <a href="/historique" className="text-[#10B981] underline">historique vérifiable publiquement</a>,
                une <a href="/methodologie" className="text-[#10B981] underline">méthodologie documentée</a> et
          ...
          <div initial="hidden" className="mb-6">
            ...
            <div className="space-y-2">
              {FAQ_ITEMS.slice(0, 4).map((item, i) => (
                <div key={item.q} className="rounded-xl overflow-hidden" style={{ backgroundColor: '#1E293B', border: '1px solid rgba(242, 247, 245, 0.08)' }}>
                  ...
                  {openFaq === i && (
                    <div className="px-4 pb-3 text-[11px] text-[#10B981] leading-relaxed">{item.a}</div>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            {[
              ...
              <a key={link.label} href={link.href} className="text-center text-[10px] text-[#94A3B8] hover:text-[#10B981] transition-colors py-2">
                {link.label}
              </a>
            ))}
          </div>
          ...
          {/* Legal text */}
          <div className="rounded-xl p-4 mb-3" style={{ backgroundColor: '#1E293B' }}>
            ...
            <p className="text-[10px] text-[#94A3B8] leading-relaxed">
              <strong className="text-[#10B981]">Avertissement :</strong> {LEGAL.disclaimer}
            </p>
          </div>
          ...
          <div className="text-center text-[10px] text-[#94A3B8] mt-3 space-y-1">
          ...
          <div className="text-center text-[10px] text-[#334155] mt-2">
            {LEGAL.copyright}
          </div>
        </div>
      </footer>
