...
export default function Footer() {
  ...
  return (
    <>
      <footer ref={ref} id="faq" className="border-t pt-10 pb-20 sm:pb-8 px-4" style={{ borderColor: '#D4AF37', backgroundColor: '#070A14' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <div initial="hidden" className="mb-6">
            <div className="text-center mb-3">
              <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#D4AF37]">Transparence</span>
            </div>
            <div className="p-4 rounded-xl text-center" style={{ backgroundColor: '#111827', border: '1px solid rgba(247, 248, 255, 0.08)' }}>
              <p className="text-[11px] text-[#94A3B8] leading-relaxed">
                BTTSPredict ne publie pas de témoignages clients. Notre engagement de transparence repose sur
                un <a href="/historique" className="text-[#D4AF37] underline">historique vérifiable publiquement</a>,
                une <a href="/methodologie" className="text-[#D4AF37] underline">méthodologie documentée</a> et
          ...
          <div initial="hidden" className="mb-6">
            ...
            <div className="space-y-2">
              {FAQ_ITEMS.slice(0, 4).map((item, i) => (
                <div key={item.q} className="rounded-xl overflow-hidden" style={{ backgroundColor: '#111827', border: '1px solid rgba(247, 248, 255, 0.08)' }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            {[
              ...
              <a key={link.label} href={link.href} className="text-center text-[10px] text-[#94A3B8] hover:text-[#D4AF37] transition-colors py-2">
                {link.label}
              </a>
            ))}
          </div>
          ...
          {/* Legal text */}
          <div className="rounded-xl p-4 mb-3" style={{ backgroundColor: '#111827' }}>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[#D4AF37] font-extrabold text-xs">18+</span>
              <span className="text-[10px] text-[#94A3B8]">| {LONASE.name} | Jeu responsable</span>
            </div>
          ...
          <p className="text-center text-[10px] text-[#94A3B8] mb-2 leading-relaxed">
          ...
          {/* Identité éditeur */}
          <div className="text-center text-[10px] text-[#64748B] mt-3 space-y-1">
            <div>Éditeur: BTTSPredict — Elon Ervri, New Jersey, USA · Contact conformité: {''}
              <a href="mailto:contact@bttspredict.com" className="underline hover:text-[#94A3B8]">contact@bttspredict.com</a>
            </div>
          ...
          <div className="text-center text-[10px] text-[#1F2937] mt-2">
            {LEGAL.copyright}
          </div>
        </div>
      </footer>
