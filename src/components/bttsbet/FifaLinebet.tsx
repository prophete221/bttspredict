          ...
          >
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-1.5 mb-3">
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: '#0D2029' }}>
                ...
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: 'rgba(24, 224, 181,0.06)' }}>
