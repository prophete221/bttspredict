          ...
          >
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-1.5 mb-3">
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: '#FFFFFF' }}>
                ...
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: 'rgba(18, 18, 18,0.06)' }}>
