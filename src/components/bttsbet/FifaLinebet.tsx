...
const C = {
  bg: '#0B1220', card: '#0F172A', border: 'rgba(248, 250, 252, 0.08)',
  green: '#16C7A3', greenLight: '#16C7A3', gold: '#16C7A3', cyan: '#16C7A3', violet: '#16C7A3',
  text: '#F8FAFC', textSec: '#AAB7CC', textMute: '#AAB7CC',
}
      ...
      <section ref={ref} id="fifa-linebet" className="section-pad overflow-x-hidden" style={{ paddingTop: '16px', paddingBottom: '16px' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            style={{ backgroundColor: C.card, border: '1px solid ' + C.border, boxShadow: '0 4px 20px rgba(11, 18, 32,0.3)' }}
          >
            {/* Top accent — gold */}
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-2.5 mb-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(22, 199, 163,0.1)', border: '1px solid rgba(22, 199, 163,0.2)' }}>
                ...
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded" style={{ backgroundColor: 'rgba(22, 199, 163,0.1)' }}>
              ...
              {/* Warning — compact */}
              <div className="p-2 rounded-lg mb-3" style={{ backgroundColor: 'rgba(22, 199, 163,0.06)', border: '1px solid rgba(22, 199, 163,0.15)' }}>
              ...
              <div className="flex items-center gap-1.5 mb-3">
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: '#0F172A' }}>
                ...
                <div className="flex-1 p-2 rounded-lg text-center" style={{ backgroundColor: 'rgba(22, 199, 163,0.06)' }}>
              ...
              <div className="relative">
                <div className="space-y-1" style={{ filter: 'blur(5px)', opacity: 0.4, pointerEvents: 'none' }}>
                  {matches.map((m, i) => (
                    <div key={i} className="flex items-center justify-between px-2 py-1.5 rounded" style={{ backgroundColor: 'rgba(248, 250, 252,0.02)' }}>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #16C7A3, #16C7A3)', color: '#F8FAFC' }}
              >
