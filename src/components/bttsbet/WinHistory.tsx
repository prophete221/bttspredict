...
function HistoryRow({ item, index }: { item: HistoryItem; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`grid grid-cols-1 sm:grid-cols-5 gap-1 sm:gap-3 px-4 py-2.5 border-t border-edge/30 hover:bg-emerald/[0.03] transition-colors items-center ${isAlt ? 'bg-white/[0.01]' : ''}`}
    >
    ...
    <section ref={ref} id="win-history" className="py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-panel border border-edge/40 rounded-2xl overflow-hidden"
        >
