          ...
          <div key={d.name}>
            ...
            <div className="relative h-2 bg-dark-700 rounded-full overflow-hidden">
              <motion.div
                ...
                style={{ boxShadow: '0 0 8px rgba(168, 190, 176, 0.4)' }}
              />
            </div>
    ...
    <section ref={ref} id="win-history" className="section-pad overflow-x-hidden">
      <div className="max-w-[440px] sm:max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(224, 193, 145, 0.04), rgba(224, 193, 145, 0.04))',
            border: '1px solid rgba(224, 193, 145, 0.12)',
          }}
        >
