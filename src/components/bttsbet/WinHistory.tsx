    ...
    <div className="squircle-lg p-4 sm:p-5">
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-[10px] text-gray-400 mt-0.5">Taux de réussite quotidien</p>
        </div>
    ...
    <div className="squircle-lg p-4 sm:p-5">
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-[10px] text-gray-400 mt-0.5">BTTS vs Over 2.5</p>
        </div>
      </div>
        ...
        {data.map(d => (
          <div key={d.name}>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="text-gray-400 font-semibold">{d.name}</span>
            ...
            <div className="relative h-2 bg-dark-700 rounded-full overflow-hidden">
              <motion.div
                ...
                style={{ boxShadow: '0 0 8px rgba(31, 138, 112, 0.4)' }}
              />
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <div className="text-[11px] text-gray-400 mono tabular-nums">{item.date.slice(5)}</div>
        <div className="text-[9px] text-gray-400">{item.league}</div>
      </div>
      ...
      <div className="min-w-0 text-center">
        ...
        <div className="text-[9px] text-gray-400">conf. {item.confidence}%</div>
      </div>
    ...
    return (
      <section ref={ref} id="win-history" className="section-pad overflow-x-hidden">
        <div className="max-w-[440px] sm:max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm mt-2">Historique en cours de mise à jour…</p>
        </div>
      </section>
    )
  }
      ...
      <div className="max-w-[440px] sm:max-w-2xl mx-auto">
        ...
        >
          <motion.div variants={undefined} className="stat-tile">
            ...
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mt-1">Analysés</div>
          </motion.div>
          <motion.div variants={undefined} className="stat-tile">
            <div className="text-2xl sm:text-3xl font-bold text-success tabular-nums glow-text-green" ref={wonRef}>{wonDisplay}</div>
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mt-1">Gagnés</div>
          </motion.div>
          <motion.div variants={undefined} className="stat-tile">
            <div className="text-2xl sm:text-3xl font-bold text-lose tabular-nums" ref={lostRef}>{lostDisplay}</div>
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mt-1">Perdus</div>
          </motion.div>
          <motion.div variants={undefined} className="stat-tile">
            <div className="text-2xl sm:text-3xl font-bold text-gold tabular-nums glow-text-gold" ref={rateRef}>{rateDisplay}%</div>
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mt-1">Réussite</div>
          </motion.div>
        </motion.div>
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          <span className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mr-1">Résultat:</span>
          {([
            { id: 'all', label: 'Tous' },
            { id: 'won', label: 'Gagnés' },
          ...
          <span className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mr-1">Type:</span>
          {([
            { id: 'all', label: 'Tous' },
            { id: 'BTTS', label: 'BTTS' },
        ...
        <div className="squircle-lg overflow-hidden">
          <div className="hidden md:grid px-4 py-2 text-[10px] text-gray-400 uppercase tracking-widest font-bold border-b border-edge bg-panel-2"
        ...
        >
          ...
          <span className="text-[10px] text-gray-400">Gagnés ET perdus affichés en transparence</span>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(168, 162, 158, 0.04), rgba(168, 162, 158, 0.04))',
