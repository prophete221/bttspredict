...
const LEAGUE_COLORS = ['#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C', '#E6A24C']
    ...
    >
      ...
      {isUpdating && pending > 100 && (
        <div className="mb-4 p-4 rounded-xl flex items-start gap-3" style={{ backgroundColor: 'rgba(99, 216, 208, 0.08)', border: '1px solid rgba(99, 216, 208, 0.25)' }}>
          <svg className="flex-shrink-0 mt-0.5" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9896FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <header className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-3 text-[10px]">
            <span className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-sm" style={{ backgroundColor: '#E6A24C' }} />
          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={timeSeriesDual} margin={{ top: 8, right: 8, bottom: 0, left: -16 }}>
              ...
              <Tooltip
                ...
                labelStyle={{ color: '#F3F7F5', fontWeight: 700 }}
