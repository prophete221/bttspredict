...
function PredictionCard({ pred }: { pred: Prediction }) {
  ...
  const probaColor = isBTTS ? '#10B981' : '#10B981' // assombri cyan #10B981 → #10B981
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 0 20px rgba(81, 70, 245, 0.3), 0 8px 32px rgba(7, 11, 24, 0.5)'
      }}
      onMouseLeave={(e) => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span
            ...
            style={{
              backgroundColor: isBTTS ? 'rgba(124, 58, 237, 0.12)' : 'rgba(93, 253, 203, 0.12)',
              color: probaColor,
              border: `1px solid ${isBTTS ? 'rgba(124, 58, 237, 0.25)' : 'rgba(93, 253, 203, 0.25)'}`,
            }}
          >
