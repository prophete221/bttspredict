          ...
          <div className="hidden sm:flex items-center gap-0.5 overflow-x-auto no-scrollbar pb-1.5" style={{ scrollbarWidth: 'none' }}>
            {PAGE_LINKS.map((link) => (
              <a
                ...
                style={{ color: '#B5C4C9' }}
                onMouseEnter={(e) => { e.currentTarget.style.color = '#C7F464'; e.currentTarget.style.backgroundColor = 'rgba(199, 244, 100, 0.08)' }}
                onMouseLeave={(e) => { e.currentTarget.style.color = '#B5C4C9'; e.currentTarget.style.backgroundColor = 'transparent' }}
              >
                {link.label}
              </a>
            ))}
