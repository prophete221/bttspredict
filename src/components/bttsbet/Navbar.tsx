    ...
    <>
          ...
          <div className="hidden sm:flex items-center gap-0.5 overflow-x-auto no-scrollbar pb-1.5" style={{ scrollbarWidth: 'none' }}>
            {PAGE_LINKS.map((link) => (
              <a
                ...
                style={{ color: '#6B7280' }}
                onMouseEnter={(e) => { e.currentTarget.style.color = '#121212'; e.currentTarget.style.backgroundColor = 'rgba(18, 18, 18, 0.08)' }}
      ...
      {menuOpen && (
        <>
          ...
          >
            {/* Header du drawer */}
            <div className="flex items-center justify-between px-4 py-3 border-b" style={{ borderColor: 'rgba(18, 18, 18, 0.15)' }}>
              <span className="text-sm font-bold text-[#111827]">Navigation</span>
              <button
                onClick={() => setMenuOpen(false)}
            ...
            <div className="p-3 grid grid-cols-2 gap-2">
              {PAGE_LINKS.map((link) => (
                <a
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'rgba(18, 18, 18, 0.18)' }}
            ...
            <div className="px-4 py-3 border-t flex items-center gap-2" style={{ borderColor: 'rgba(18, 18, 18, 0.15)' }}>
              <button
