        ...
        {visible && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 12px 32px rgba(0, 0, 0, 0.4), 0 0 60px rgba(245, 158, 11, 0.15), inset 0 1px 0 #A8B3C2',
            }}
          >
            {/* Top shimmer line */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr_auto] items-center gap-3 sm:gap-5 p-4 sm:p-5">
              ...
              <div className="hidden sm:flex items-center justify-center gap-5 text-[11px]">
                <div className="flex items-center gap-1.5">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#00A882" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="sm:hidden flex items-center justify-around gap-2 px-4 pb-3 text-[10px]">
              <div className="flex items-center gap-1">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#00A882" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
