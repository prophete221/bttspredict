        ...
        {visible && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 12px 32px rgba(7, 17, 26, 0.4), 0 0 60px rgba(199, 244, 100, 0.15), inset 0 1px 0 #B5C4C9',
            }}
          >
            {/* Top shimmer line */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr_auto] items-center gap-3 sm:gap-5 p-4 sm:p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative w-12 h-12 rounded-xl bg-gold/10 border border-gold/30 flex items-center justify-center flex-shrink-0">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="#C7F464" stroke="#C7F464" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <button
                  onClick={handleCta}
                  className="inline-flex items-center gap-1.5 px-4 sm:px-5 py-2.5 btn-gold cta-glow text-[#102333] text-xs sm:text-sm font-bold rounded-lg whitespace-nowrap"
                >
