...
const C = {
  bg: '#09141D', card: '#0D2029', border: 'rgba(241, 248, 245, 0.08)',
  green: '#18E0B5', greenLight: '#18E0B5', gold: '#18E0B5', cyan: '#18E0B5', violet: '#18E0B5',
  text: '#F1F8F5', textSec: '#9BB8BD', textMute: '#9BB8BD',
  danger: '#18E0B5',
}
...
export default function AviatorVip() {
  ...
  return (
    <>
      <section ref={ref} id="aviator" className="section-pad overflow-x-hidden" style={{ paddingTop: '16px', paddingBottom: '16px', backgroundColor: '#09141D' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            style={{ backgroundColor: C.card, border: '1px solid ' + C.border, boxShadow: '0 4px 20px rgba(9, 20, 29,0.3)' }}
          >
            {/* Top accent */}
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-2.5 mb-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(24, 224, 181,0.1)', border: '1px solid rgba(24, 224, 181,0.2)' }}>
                ...
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded" style={{ backgroundColor: 'rgba(24, 224, 181,0.1)' }}>
              ...
              {/* Warning — compact */}
              <div className="p-2 rounded-lg mb-3" style={{ backgroundColor: 'rgba(24, 224, 181,0.06)', border: '1px solid rgba(24, 224, 181,0.15)' }}>
              ...
              <div className="grid grid-cols-2 gap-1.5 mb-3">
                <div className="p-2 rounded-lg text-center" style={{ backgroundColor: 'rgba(24, 224, 181,0.06)' }}>
              ...
              <div className="relative">
                <div className="space-y-1" style={{ filter: 'blur(5px)', opacity: 0.4, pointerEvents: 'none' }}>
                  {rounds.map((r, i) => (
                    <div key={i} className="flex items-center justify-between px-2 py-1.5 rounded" style={{ backgroundColor: 'rgba(241, 248, 245,0.02)' }}>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #18E0B5, #18E0B5)', color: '#F1F8F5' }}
              >
