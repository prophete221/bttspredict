...
const C = {
  bg: '#07111A', card: '#102333', border: 'rgba(242, 247, 245, 0.08)',
  green: '#C7F464', greenLight: '#C7F464', gold: '#C7F464', cyan: '#C7F464', violet: '#C7F464',
  text: '#F2F7F5', textSec: '#B5C4C9', textMute: '#B5C4C9',
  danger: '#C7F464',
}
...
export default function AviatorVip() {
  ...
  return (
    <>
      <section ref={ref} id="aviator" className="section-pad overflow-x-hidden" style={{ paddingTop: '16px', paddingBottom: '16px', backgroundColor: '#07111A' }}>
