...
const C = {
  bg: '#F1F2F3', card: '#FFFFFF', border: 'rgba(17, 24, 39, 0.08)',
  green: '#121212', greenLight: '#121212', gold: '#121212', cyan: '#121212', violet: '#121212',
  text: '#111827', textSec: '#6B7280', textMute: '#6B7280',
  danger: '#121212',
}
...
export default function AviatorVip() {
  ...
  return (
    <>
      <section ref={ref} id="aviator" className="section-pad overflow-x-hidden" style={{ paddingTop: '16px', paddingBottom: '16px', backgroundColor: '#F1F2F3' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            style={{ backgroundColor: C.card, border: '1px solid ' + C.border, boxShadow: '0 4px 20px rgba(241, 242, 243,0.3)' }}
          >
            {/* Top accent */}
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-2.5 mb-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(18, 18, 18,0.1)', border: '1px solid rgba(18, 18, 18,0.2)' }}>
                ...
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded" style={{ backgroundColor: 'rgba(18, 18, 18,0.1)' }}>
              ...
              {/* Warning — compact */}
              <div className="p-2 rounded-lg mb-3" style={{ backgroundColor: 'rgba(18, 18, 18,0.06)', border: '1px solid rgba(18, 18, 18,0.15)' }}>
              ...
              <div className="grid grid-cols-2 gap-1.5 mb-3">
                <div className="p-2 rounded-lg text-center" style={{ backgroundColor: 'rgba(18, 18, 18,0.06)' }}>
              ...
              <div className="relative">
                <div className="space-y-1" style={{ filter: 'blur(5px)', opacity: 0.4, pointerEvents: 'none' }}>
                  {rounds.map((r, i) => (
                    <div key={i} className="flex items-center justify-between px-2 py-1.5 rounded" style={{ backgroundColor: 'rgba(17, 24, 39,0.02)' }}>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #121212, #121212)', color: '#111827' }}
              >
