    ...
    <div className={`relative ${className}`}>
      <div className="animate-pulse-scale" style={{ width: size, height: size }}>
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
          <circle cx="24" cy="24" r="20" stroke="#00D4FF" strokeWidth="1" opacity="0.2" />
          {/* Brain shape */}
          <path d="M16 28c0-6 3-10 8-12 5 2 8 6 8 12" stroke="#00D4FF" strokeWidth="1.5" fill="none" />
          <path d="M16 28c-2-1-3-4-2-7s4-5 6-5" stroke="#00D4FF" strokeWidth="1.5" fill="none" />
          <path d="M32 28c2-1 3-4 2-7s-4-5-6-5" stroke="#00D4FF" strokeWidth="1.5" fill="none" />
          <path d="M20 20c1-3 3-5 4-6" stroke="#00D4FF" strokeWidth="1" opacity="0.5" />
          <path d="M28 20c-1-3-3-5-4-6" stroke="#00D4FF" strokeWidth="1" opacity="0.5" />
          {/* Neural connections */}
          <circle cx="20" cy="22" r="1.5" fill="#00D4FF" opacity="0.8" />
          <circle cx="28" cy="22" r="1.5" fill="#00D4FF" opacity="0.8" />
          <circle cx="24" cy="26" r="1.5" fill="#00D4FF" opacity="0.6" />
          <line x1="20" y1="22" x2="24" y2="26" stroke="#00D4FF" strokeWidth="0.5" opacity="0.4" />
          <line x1="28" y1="22" x2="24" y2="26" stroke="#00D4FF" strokeWidth="0.5" opacity="0.4" />
          <line x1="20" y1="22" x2="28" y2="22" stroke="#00D4FF" strokeWidth="0.5" opacity="0.3" />
          {/* Sparkle */}
    ...
    <div className={`relative ${className}`}>
      <div className="animate-rocket" style={{ width: size, height: size }}>
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
          ...
          {/* Window */}
          <circle cx="24" cy="20" r="3" fill="#00D4FF" opacity="0.5" stroke="#00D4FF" strokeWidth="1" />
          {/* Fins */}
          ...
          <circle cx="38" cy="16" r="0.8" fill="#00D4FF" opacity="0.3">
            <animate attributeName="opacity" values="0.1;0.6;0.1" dur="2s" repeatCount="indefinite" />
          </circle>
          <circle cx="36" cy="8" r="0.6" fill="#00D4FF" opacity="0.3">
    ...
    <div className={`relative ${className}`}>
      <div className="animate-float-drift" style={{ width: size, height: size }}>
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
          ...
          {/* Jewels */}
          <circle cx="16" cy="30" r="2" fill="#00D4FF" opacity="0.7">
            <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite" />
          </circle>
          <circle cx="24" cy="28" r="2" fill="#00D4FF" opacity="0.7">
    ...
    <div className={`relative ${className}`}>
      <div className="animate-wiggle" style={{ width: size, height: size }}>
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
          ...
          <circle cx="32" cy="30" r="2" fill="#00D4FF" opacity="0.5" />
          {/* Antenna / signal */}
    ...
    <div className={`relative ${className}`}>
      <div style={{ width: size, height: size }}>
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
          ...
          <rect x="35" y="8" width="6" height="32" rx="1" fill="#00D4FF" opacity="0.3">
...
export function FloatingParticles({ count = 12, className = '' }: { count?: number; className?: string }) {
  const particles = Array.from({ length: count }, (_, i) => {
    const colors = ['#FACC15', '#00D4FF', '#FDE047', '#4ADE80']
