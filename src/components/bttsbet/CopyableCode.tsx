    ...
    return (
      <span className={`inline-flex items-center gap-1.5 ${className}`}>
        <motion.button
          ...
          style={{
            background: 'linear-gradient(100deg, #E6A24C 0%, #E6A24C 30%, #E6A24C 50%, #E6A24C 70%, #E6A24C 100%)',
        ...
        <motion.button
          ...
          style={{ color: copied ? '#E6A24C' : '#E6A24C' }}
          aria-label="Copier"
        >
          {copied ? (
  ...
  return (
    <span className={`inline-flex items-center gap-1 ${className}`}>
      <motion.button
        ...
        aria-label={`Copier le code promo ${code}`}
        style={{ borderBottom: '1px dashed rgba(127, 162, 198, 0.30)' }}
      >
        {code}
      </motion.button>
      <motion.button
