    ...
    return (
      <span className={`inline-flex items-center gap-1.5 ${className}`}>
        <motion.button
          ...
          style={{
            background: 'linear-gradient(100deg, #C9A227 0%, #FFE066 30%, #C9A227 50%, #FFE066 70%, #C9A227 100%)',
        ...
        <motion.button
          ...
          style={{ color: copied ? '#C9A227' : '#C9A227' }}
          aria-label="Copier"
        >
          {copied ? (
  ...
  return (
    <span className={`inline-flex items-center gap-1 ${className}`}>
      <motion.button
        ...
        aria-label={`Copier le code promo ${code}`}
        style={{ borderBottom: '1px dashed rgba(201, 162, 39, 0.3)' }}
      >
        {code}
      </motion.button>
      <motion.button
