    ...
    <>
      <section ref={ref} id="vip" className="section-pad overflow-x-hidden relative overflow-hidden" style={{ paddingTop: '24px', paddingBottom: '24px' }}>
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(50% 30% at 50% 0%, rgba(0, 196, 154,0.06) 0%, transparent 70%)',
        }} />
        ...
        <div className="max-w-[440px] mx-auto relative">
          ...
          >
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-[10px]" style={{ background: '#161B22', border: '1px solid rgba(240, 242, 245, 0.08)' }}>
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-[10px]" style={{ background: 'rgba(0, 196, 154,0.06)', border: '1px solid rgba(0, 196, 154,0.15)' }}>
          ...
          style={{ backgroundColor: '#161B22', border: '1px solid rgba(240, 242, 245, 0.08)', boxShadow: '0 8px 30px rgba(0,0,0,0.4)' }}
            style={{ boxShadow: '0 8px 30px rgba(0,0,0,0.4)' }}
          >
            {/* Top accent line */}
            <div className="h-[2px] w-full" style={{ background: 'linear-gradient(90deg, transparent, rgba(0, 196, 154,0.4), transparent)' }} />
                ...
                <div className="absolute inset-0 flex items-center justify-center" style={{
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      color: '#0D1117',
                      boxShadow: '0 4px 20px rgba(0, 196, 154,0.3)',
                    }}
                    data-cta="vip-unlock"
                  >
            ...
            {/* Cote totale bar */}
            <div className="px-3 py-2.5 flex items-center justify-between border-t" style={{ borderColor: '#161B22' }}>
