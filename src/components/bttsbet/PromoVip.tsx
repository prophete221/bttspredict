...
export default function PromoVip() {
  ...
  return (
    <>
      <section ref={ref} id="vip" className="section-pad relative overflow-hidden" style={{ paddingTop: '24px', paddingBottom: '24px' }}>
        {/* Background glow */}
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(50% 30% at 50% 0%, rgba(0,255,136,0.06) 0%, transparent 70%)',
        }} />
        ...
        <div className="max-w-[440px] mx-auto relative">
          ...
          >
            {/* Top accent line */}
            <div className="h-[2px] w-full" style={{ background: 'linear-gradient(90deg, transparent, rgba(0,255,136,0.4), transparent)' }} />
          ...
          >
            ...
            <span className="text-[11px] text-right" style={{ color: C.textSec }}>
              Bonus<br /><span className="font-bold" style={{ color: C.neon }}>90 000 XOF</span>
            </span>
          </motion.div>
        </div>
      </section>
