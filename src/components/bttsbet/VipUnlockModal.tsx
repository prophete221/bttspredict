        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ backgroundColor: '#0D1B2A', border: '1px solid rgba(242, 247, 245,0.1)' }}
              aria-label="Fermer"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#F4F8FC" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
            </button>
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#0D1B2A', border: '1px solid rgba(199, 244, 100,0.3)' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-papier">{title}</h3>
                    <p className="text-[11px] text-[#B7C7D9]">3 étapes pour accéder au VIP</p>
                  </div>
                </div>
                ...
                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(199, 244, 100,0.1)', border: '1px solid rgba(199, 244, 100,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#16A36A] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#0D1B2A', color: '#16A36A', border: '1px solid rgba(199, 244, 100,0.3)' }}>1</span>
                  ...
                  >
                    <div>
                      <div className="text-[10px] uppercase tracking-widest font-bold mb-1" style={{ color: '#B7C7D9' }}>
                        Code promo {selectedBookmaker === '888starz' ? '(minuscules)' : '(majuscules)'}
                      </div>
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#16A36A' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(199, 244, 100, 0.15)' : 'rgba(199, 244, 100, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#16A36A]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#16A36A]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #16A36A' : '1px solid #B7C7D9',
                    }}
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === 'linebet' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#16A36A]">
                          Code : <span className="font-mono font-bold text-[#16A36A]">VISION221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(199, 244, 100, 0.1)', color: '#16A36A' }}>Bonus exclusif</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #16A36A' : '1px solid #B7C7D9',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#0D1B2A', color: '#16A36A', border: '1px solid rgba(199, 244, 100,0.3)' }}>2</span>
                  <div className="text-sm text-[#16A36A]">
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#0D1B2A', color: '#16A36A', border: '1px solid rgba(199, 244, 100,0.3)' }}>3</span>
                  <div className="text-sm text-[#16A36A]">
                    <span className="text-papier font-semibold">Vérifie ton ID joueur</span> ci-dessous.
                    <span className="block mt-1 text-[10px] text-[#B7C7D9]">🔒 Aucune donnée collectée — vérifié localement (SHA-256) dans ton navigateur.</span>
                  </div>
                </div>

                {/* ID input */}
                <div className="mb-4">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-[#B7C7D9] mb-2">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#0D1B2A',
                      border: selectedBookmaker ? '1px solid rgba(242, 247, 245,0.12)' : '1px solid #B7C7D9',
                      opacity: selectedBookmaker ? 1 : 0.5,
                    }}
                  />
                  {verificationError && <p className="text-[11px] text-[#16A36A] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#0D1B2A' : '#16A36A',
                      color: !selectedBookmaker || !playerId.trim() ? '#B7C7D9' : '#07111F',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#0D1B2A', border: '1px solid rgba(242, 247, 245, 0.08)' }}>
                  <p className="text-[10px] text-[#B7C7D9] leading-relaxed">
                    <span className="text-[#16A36A] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(199, 244, 100,0.1)', border: '2px solid #16A36A' }}
                >
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#16A36A" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                </motion.div>
                <h3 className="text-xl font-bold text-papier mb-2">VIP débloqué ! 🎉</h3>
                <p className="text-sm text-[#16A36A] mb-4">
                  Ton ID <span className="font-mono text-[#16A36A]">{playerId.slice(0, 4)}•••••</span> a été vérifié chez{' '}
