        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ backgroundColor: '#0D202D', border: '1px solid rgba(244, 247, 251,0.1)' }}
              aria-label="Fermer"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#F3F7F5" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
            </button>
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#0D202D', border: '1px solid rgba(75, 182, 135,0.3)' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-papier">{title}</h3>
                    <p className="text-[11px] text-[#B4C4CC]">Un parcours clair en 3 étapes</p>
                  </div>
                </div>
                ...
                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(75, 182, 135,0.1)', border: '1px solid rgba(75, 182, 135,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#E6A24C] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#0D202D', color: '#E6A24C', border: '1px solid rgba(75, 182, 135,0.3)' }}>1</span>
                  ...
                  >
                    <div>
                      <div className="text-[10px] uppercase tracking-widest font-bold mb-1" style={{ color: '#B4C4CC' }}>
                        Code promo {selectedBookmaker === '888starz' ? '(minuscules)' : '(majuscules)'}
                      </div>
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#E6A24C' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(75, 182, 135, 0.15)' : 'rgba(75, 182, 135, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#E6A24C]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#E6A24C]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #E6A24C' : '1px solid #B4C4CC',
                    }}
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === 'linebet' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#E6A24C]">
                          Code : <span className="font-mono font-bold text-[#E6A24C]">VISION221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(245, 196, 81, 0.12)', color: '#E6A24C' }}>Partenaire officiel</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #E6A24C' : '1px solid #B4C4CC',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#0D202D', color: '#E6A24C', border: '1px solid rgba(75, 182, 135,0.3)' }}>2</span>
                  <div className="text-sm text-[#E6A24C]">
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#0D202D', color: '#E6A24C', border: '1px solid rgba(75, 182, 135,0.3)' }}>3</span>
                  <div className="text-sm text-[#E6A24C]">
                    <span className="text-papier font-semibold">Saisis ton ID joueur</span> pour la vérification locale.
                    <span className="block mt-1 text-[10px] text-[#B4C4CC]">🔒 Aucune donnée collectée — vérifié localement (SHA-256) dans ton navigateur.</span>
                  </div>
                </div>

                {/* ID input */}
                <div className="mb-4">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-[#B4C4CC] mb-2">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#0D202D',
                      border: selectedBookmaker ? '1px solid rgba(244, 247, 251,0.12)' : '1px solid #B4C4CC',
                      opacity: selectedBookmaker ? 1 : 0.5,
                    }}
                  />
                  {verificationError && <p className="text-[11px] text-[#E6A24C] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#0D202D' : '#E6A24C',
                      color: !selectedBookmaker || !playerId.trim() ? '#B4C4CC' : '#07131D',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#0D202D', border: '1px solid rgba(244, 247, 251, 0.08)' }}>
                  <p className="text-[10px] text-[#B4C4CC] leading-relaxed">
                    <span className="text-[#E6A24C] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(75, 182, 135,0.1)', border: '2px solid #E6A24C' }}
                >
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#E6A24C" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                </motion.div>
                <h3 className="text-xl font-bold text-papier mb-2">Espace VIP débloqué</h3>
                <p className="text-sm text-[#E6A24C] mb-4">
                  Ton ID <span className="font-mono text-[#E6A24C]">{playerId.slice(0, 4)}•••••</span> a été enregistré localement pour{' '}
