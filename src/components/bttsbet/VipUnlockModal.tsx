              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#111827', border: '1px solid rgba(81, 70, 245,0.3)' }}>
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#94A3B8]">3 étapes pour accéder au VIP</p>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#111827', color: '#D4AF37', border: '1px solid rgba(81, 70, 245,0.3)' }}>1</span>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #D4AF37' : '1px solid #94A3B8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(81, 70, 245, 0.1)', color: '#D4AF37' }}>Bonus exclusif</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #D4AF37' : '1px solid #94A3B8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#111827', color: '#D4AF37', border: '1px solid rgba(81, 70, 245,0.3)' }}>2</span>
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#111827', color: '#D4AF37', border: '1px solid rgba(81, 70, 245,0.3)' }}>3</span>
                  <div className="text-sm text-[#D4AF37]">
                    <span className="text-papier font-semibold">Vérifie ton ID joueur</span> ci-dessous.
                    <span className="block mt-1 text-[10px] text-[#94A3B8]">🔒 Aucune donnée collectée — vérifié localement (SHA-256) dans ton navigateur.</span>
                  </div>
                </div>

                {/* ID input */}
                <div className="mb-4">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-[#94A3B8] mb-2">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#111827',
                      border: selectedBookmaker ? '1px solid rgba(247, 248, 255,0.12)' : '1px solid #94A3B8',
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  {selectedBookmaker === '888starz' && (
                    <a href={AFFILIATE.star888} rel="sponsored noopener" target="_blank"
                      className="flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-xs font-bold"
                      style={{ backgroundColor: '#D4AF37', color: '#070A14' }}>
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#111827' : '#D4AF37',
                      color: !selectedBookmaker || !playerId.trim() ? '#94A3B8' : '#070A14',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#111827', border: '1px solid rgba(247, 248, 255, 0.08)' }}>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(81, 70, 245,0.1)', border: '2px solid #D4AF37' }}
                >
