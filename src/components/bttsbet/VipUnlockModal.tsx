        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ backgroundColor: '#1E293B', border: '1px solid rgba(242, 247, 245,0.1)' }}
              aria-label="Fermer"
            >
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#1E293B', border: '1px solid rgba(199, 244, 100,0.3)' }}>
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#1E293B', color: '#10B981', border: '1px solid rgba(199, 244, 100,0.3)' }}>1</span>
                  ...
                  >
                    <div>
                      ...
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#10B981' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(199, 244, 100, 0.15)' : 'rgba(199, 244, 100, 0.1)' }}>
                      {copied ? (
                        ...
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#10B981]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #10B981' : '1px solid #94A3B8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-[11px] text-[#10B981]">
                          Code : <span className="font-mono font-bold text-[#10B981]">VISION221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(199, 244, 100, 0.1)', color: '#10B981' }}>Bonus exclusif</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #10B981' : '1px solid #94A3B8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1E293B', color: '#10B981', border: '1px solid rgba(199, 244, 100,0.3)' }}>2</span>
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1E293B', color: '#10B981', border: '1px solid rgba(199, 244, 100,0.3)' }}>3</span>
                  <div className="text-sm text-[#10B981]">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#1E293B',
                      border: selectedBookmaker ? '1px solid rgba(242, 247, 245,0.12)' : '1px solid #94A3B8',
                      opacity: selectedBookmaker ? 1 : 0.5,
                    }}
                  />
                  {verificationError && <p className="text-[11px] text-[#10B981] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#1E293B' : '#10B981',
                      color: !selectedBookmaker || !playerId.trim() ? '#94A3B8' : '#0F172A',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#1E293B', border: '1px solid rgba(242, 247, 245, 0.08)' }}>
                  <p className="text-[10px] text-[#94A3B8] leading-relaxed">
                    <span className="text-[#10B981] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(199, 244, 100,0.1)', border: '2px solid #10B981' }}
                >
