              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(199, 244, 100,0.1)', border: '1px solid rgba(199, 244, 100,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#9CC4F4] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#111722', color: '#9CC4F4', border: '1px solid rgba(199, 244, 100,0.3)' }}>1</span>
                  ...
                  >
                    <div>
                      ...
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#9CC4F4' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(199, 244, 100, 0.15)' : 'rgba(199, 244, 100, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#9CC4F4]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#9CC4F4]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #9CC4F4' : '1px solid #9BA7B8',
                    }}
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === 'linebet' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#9CC4F4]">
                          Code : <span className="font-mono font-bold text-[#9CC4F4]">VISION221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(199, 244, 100, 0.1)', color: '#9CC4F4' }}>Bonus exclusif</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #9CC4F4' : '1px solid #9BA7B8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#111722', color: '#9CC4F4', border: '1px solid rgba(199, 244, 100,0.3)' }}>2</span>
                  <div className="text-sm text-[#9CC4F4]">
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#111722', color: '#9CC4F4', border: '1px solid rgba(199, 244, 100,0.3)' }}>3</span>
                  <div className="text-sm text-[#9CC4F4]">
                ...
                <div className="mb-4">
                  ...
                  />
                  {verificationError && <p className="text-[11px] text-[#9CC4F4] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#111722' : '#9CC4F4',
                ...
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#111722', border: '1px solid rgba(242, 247, 245, 0.08)' }}>
                  <p className="text-[10px] text-[#9BA7B8] leading-relaxed">
                    <span className="text-[#9CC4F4] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(199, 244, 100,0.1)', border: '2px solid #9CC4F4' }}
                >
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#9CC4F4" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                </motion.div>
                <h3 className="text-xl font-bold text-papier mb-2">VIP débloqué ! 🎉</h3>
                <p className="text-sm text-[#9CC4F4] mb-4">
                  Ton ID <span className="font-mono text-[#9CC4F4]">{playerId.slice(0, 4)}•••••</span> a été vérifié chez{' '}
