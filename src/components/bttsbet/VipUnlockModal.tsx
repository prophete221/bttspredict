        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 24px 80px rgba(13, 15, 18, 0.8)',
            }}
          ...
          >
            ...
            <button
              ...
              style={{ backgroundColor: '#1E2228', border: '1px solid rgba(244, 247, 250,0.1)' }}
              aria-label="Fermer"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#F4F7FA" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
            </button>
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#1E2228', border: '1px solid rgba(212, 175, 55,0.3)' }}>
                ...
                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(212, 175, 55,0.1)', border: '1px solid rgba(212, 175, 55,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#D4AF37] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#1E2228', color: '#D4AF37', border: '1px solid rgba(212, 175, 55,0.3)' }}>1</span>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(212, 175, 55, 0.3)',
                      boxShadow: copied ? '0 0 20px rgba(212, 175, 55, 0.2)' : 'none',
                    }}
                  ...
                  >
                    <div>
                      ...
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#D4AF37' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(212, 175, 55, 0.15)' : 'rgba(212, 175, 55, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#D4AF37]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#D4AF37]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: selectedBookmaker === 'linebet' ? 'rgba(212, 175, 55, 0.15)' : 'rgba(244, 247, 250, 0.05)',
                      border: selectedBookmaker === 'linebet' ? '1px solid #D4AF37' : '1px solid #A8B3C7',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(212, 175, 55, 0.1)', color: '#D4AF37' }}>Bonus exclusif</span>
                    </div>
                  </button>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1E2228', color: '#D4AF37', border: '1px solid rgba(212, 175, 55,0.3)' }}>2</span>
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1E2228', color: '#D4AF37', border: '1px solid rgba(212, 175, 55,0.3)' }}>3</span>
                  <div className="text-sm text-[#D4AF37]">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#1E2228',
                      border: selectedBookmaker ? '1px solid rgba(244, 247, 250,0.12)' : '1px solid #A8B3C7',
                      opacity: selectedBookmaker ? 1 : 0.5,
                    }}
                  />
                  {verificationError && <p className="text-[11px] text-[#D4AF37] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {selectedBookmaker === 'linebet' && (
                    <a href={AFFILIATE.linebet} rel="sponsored noopener" target="_blank"
                      ...
                      style={{ backgroundColor: '#D4AF37', color: '#F4F7FA' }}>
                      Inscription Linebet →
                    </a>
                  )}
                  {selectedBookmaker === '888starz' && (
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#1E2228' : '#D4AF37',
                ...
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#1E2228', border: '1px solid rgba(244, 247, 250, 0.08)' }}>
                  <p className="text-[10px] text-[#A8B3C7] leading-relaxed">
                    <span className="text-[#D4AF37] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(212, 175, 55,0.1)', border: '2px solid #D4AF37' }}
                >
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                </motion.div>
                <h3 className="text-xl font-bold text-papier mb-2">VIP débloqué ! 🎉</h3>
                <p className="text-sm text-[#D4AF37] mb-4">
                  Ton ID <span className="font-mono text-[#D4AF37]">{playerId.slice(0, 4)}•••••</span> a été vérifié chez{' '}
