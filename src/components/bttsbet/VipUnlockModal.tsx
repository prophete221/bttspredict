              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#1E2228', border: '1px solid rgba(45, 91, 255,0.3)' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-white">{title}</h3>
                    <p className="text-[11px] text-[#A8B3C7]">3 étapes pour accéder au VIP</p>
                  </div>
                </div>

                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(45, 91, 255,0.1)', border: '1px solid rgba(45, 91, 255,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#2D5BFF] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#1A1F35', color: '#2D5BFF', border: '1px solid rgba(45, 91, 255,0.3)' }}>1</span>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(45, 91, 255, 0.3)',
                      boxShadow: copied ? '0 0 20px rgba(45, 91, 255, 0.2)' : 'none',
                    }}
                    aria-label={`Copier le code promo ${currentCode}`}
                  >
                    <div>
                      <div className="text-[10px] uppercase tracking-widest font-bold mb-1" style={{ color: '#A8B3C7' }}>
                        Code promo {selectedBookmaker === '888starz' ? '(minuscules)' : '(majuscules)'}
                      </div>
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#2D5BFF' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(45, 91, 255, 0.15)' : 'rgba(45, 91, 255, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#2D5BFF]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#2D5BFF]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: selectedBookmaker === 'linebet' ? 'rgba(45, 91, 255, 0.15)' : 'rgba(244, 247, 250, 0.05)',
                      border: selectedBookmaker === 'linebet' ? '1px solid #2D5BFF' : '1px solid #A8B3C7',
                    }}
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === 'linebet' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#a0a0a0]">
                          Code : <span className="font-mono font-bold text-[#2D5BFF]">VISION221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(45, 91, 255, 0.1)', color: '#2D5BFF' }}>Bonus exclusif</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: selectedBookmaker === '888starz' ? 'rgba(212, 175, 55, 0.15)' : 'rgba(244, 247, 250, 0.05)',
                      border: selectedBookmaker === '888starz' ? '1px solid #D4AF37' : '1px solid #A8B3C7',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === '888starz' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#a0a0a0]">
                          Code : <span className="font-mono font-bold text-[#D4AF37]">vision221</span>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold px-2 py-1 rounded" style={{ backgroundColor: 'rgba(245, 158, 11, 0.1)', color: '#D4AF37' }}>Bonus exclusif</span>
                    </div>
                  </button>
                </div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1A1F35', color: '#2D5BFF', border: '1px solid rgba(45, 91, 255,0.3)' }}>2</span>
                ...
                {/* Step 3 — ID */}
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#1A1F35', color: '#2D5BFF', border: '1px solid rgba(45, 91, 255,0.3)' }}>3</span>
                  <div className="text-sm text-[#a0a0a0]">
                    <span className="text-white font-semibold">Vérifie ton ID joueur</span> ci-dessous.
                    <span className="block mt-1 text-[10px] text-[#A8B3C7]">🔒 Aucune donnée collectée — vérifié localement (SHA-256) dans ton navigateur.</span>
                  </div>
                </div>

                {/* ID input */}
                <div className="mb-4">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-[#A8B3C7] mb-2">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#1E2228',
                      border: selectedBookmaker ? '1px solid rgba(255,255,255,0.12)' : '1px solid #A8B3C7',
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#1A1F35' : '#D4AF37',
                      color: !selectedBookmaker || !playerId.trim() ? '#A8B3C7' : '#0D0F12',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#1E2228', border: '1px solid rgba(244, 247, 250, 0.08)' }}>
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(45, 91, 255,0.1)', border: '2px solid #2D5BFF' }}
                >
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#2D5BFF" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                </motion.div>
                <h3 className="text-xl font-bold text-white mb-2">VIP débloqué ! 🎉</h3>
                <p className="text-sm text-[#a0a0a0] mb-4">
                  Ton ID <span className="font-mono text-[#2D5BFF]">{playerId.slice(0, 4)}•••••</span> a été vérifié chez{' '}
