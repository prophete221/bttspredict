        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ backgroundColor: '#111a2a', border: '1px solid rgba(244, 247, 251,0.1)' }}
              aria-label="Fermer"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#F4F7FB" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
            </button>
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: '#111a2a', border: '1px solid rgba(75, 182, 135,0.3)' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7FA2C6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {alreadyUnlocked && (
                  <div className="mb-4 p-3 rounded-lg flex items-center gap-2" style={{ backgroundColor: 'rgba(75, 182, 135,0.1)', border: '1px solid rgba(75, 182, 135,0.3)' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7FA2C6" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                    <span className="text-xs text-[#7FA2C6] font-semibold">Tu as déjà débloqué le VIP.</span>
                  </div>
                )}
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ backgroundColor: '#111a2a', color: '#7FA2C6', border: '1px solid rgba(75, 182, 135,0.3)' }}>1</span>
                  ...
                  >
                    <div>
                      <div className="text-[10px] uppercase tracking-widest font-bold mb-1" style={{ color: '#C2CCD8' }}>
                        Code promo {selectedBookmaker === '888starz' ? '(minuscules)' : '(majuscules)'}
                      </div>
                      <div className="font-mono text-2xl font-black tracking-[0.1em]" style={{ color: '#7FA2C6' }}>
                        {currentCode}
                      </div>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg" style={{ backgroundColor: copied ? 'rgba(75, 182, 135, 0.15)' : 'rgba(75, 182, 135, 0.1)' }}>
                      {copied ? (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#7FA2C6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg><span className="text-xs font-bold text-[#7FA2C6]">Copié !</span></>
                      ) : (
                        <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#7FA2C6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg><span className="text-xs font-bold text-[#7FA2C6]">Copier</span></>
                      )}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === 'linebet' ? '1px solid #7FA2C6' : '1px solid #C2CCD8',
                    }}
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {selectedBookmaker === 'linebet' && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7FA2C6" strokeWidth="3"><polyline points="20 6 9 17 4 12" /></svg>
                          )}
                        </div>
                        <div className="text-[11px] text-[#7FA2C6]">
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: selectedBookmaker === '888starz' ? '1px solid #7FA2C6' : '1px solid #C2CCD8',
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <div className="mb-4 flex gap-3">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0" style={{ backgroundColor: '#111a2a', color: '#7FA2C6', border: '1px solid rgba(75, 182, 135,0.3)' }}>2</span>
                ...
                {/* ID input */}
                <div className="mb-4">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-[#C2CCD8] mb-2">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: '#111a2a',
                      border: selectedBookmaker ? '1px solid rgba(244, 247, 251,0.12)' : '1px solid #C2CCD8',
                      opacity: selectedBookmaker ? 1 : 0.5,
                    }}
                  />
                  {verificationError && <p className="text-[11px] text-[#7FA2C6] mt-1.5">{verificationError}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: !selectedBookmaker || !playerId.trim() ? '#111a2a' : '#7FA2C6',
                      color: !selectedBookmaker || !playerId.trim() ? '#C2CCD8' : '#0B1220',
                ...
                {/* Privacy */}
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#111a2a', border: '1px solid rgba(244, 247, 251, 0.08)' }}>
                  <p className="text-[10px] text-[#C2CCD8] leading-relaxed">
                    <span className="text-[#7FA2C6] font-semibold">Confidentialité totale :</span> ton ID n'est jamais envoyé à nos serveurs. Hashé localement (SHA-256) et stocké uniquement dans ton navigateur.
                  </p>
                </div>
                ...
                {/* Footer */}
                <p className="text-[10px] text-[#C2CCD8] text-center mt-3">
            ...
            {step === 'success' && (
              <div className="p-6 text-center">
                <motion.div
                  ...
                  style={{ backgroundColor: 'rgba(75, 182, 135,0.1)', border: '2px solid #7FA2C6' }}
                >
