            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="flex items-center gap-3 mb-5 pb-5 border-b" style={{ borderColor: 'rgba(199, 244, 100, 0.15)' }}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px]" style={{ color: '#B5C4C9' }}>{config.tagline}</p>
              ...
              {/* Title procédure */}
              <p className="text-[11px] uppercase tracking-widest font-bold mb-4" style={{ color: '#B5C4C9' }}>
              ...
              <div className="mb-5">
                <div className="flex items-center gap-2 mb-3">
                  <span
                    ...
                    style={{ backgroundColor: '#102333', color: config.accentColor, border: `1px solid ${config.accentColor}40` }}
                  >1</span>
              ...
              <div className="mb-5">
                ...
                <p className="text-[12px] mb-3 ml-9" style={{ color: '#B5C4C9' }}>
              ...
              >
                <p className="text-[10px] uppercase tracking-widest font-bold mb-2" style={{ color: '#B5C4C9' }}>
                  Ce que tu débloques
                </p>
                <ul className="space-y-1.5">
                  {config.perks.map((perk, i) => (
                    <li key={i} className="flex items-start gap-2 text-[12px]" style={{ color: '#B5C4C9' }}>
              ...
              {/* Confidentialité */}
              <p className="text-[10px] text-center" style={{ color: '#B5C4C9' }}>
