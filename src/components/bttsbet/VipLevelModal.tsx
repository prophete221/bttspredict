              ...
              <div className="mb-5">
                <div className="flex items-center gap-2 mb-3">
                  <span
                    ...
                    style={{ backgroundColor: '#1E293B', color: config.accentColor, border: `1px solid ${config.accentColor}40` }}
                  >1</span>
