        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 24px 80px rgba(11, 18, 32, 0.8), 0 0 40px ${config.accentColor}20`,
            }}
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="flex items-center gap-3 mb-5 pb-5 border-b" style={{ borderColor: 'rgba(22, 199, 163, 0.15)' }}>
                <div
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px]" style={{ color: '#AAB7CC' }}>{config.tagline}</p>
              ...
              {/* Title procédure */}
              <p className="text-[11px] uppercase tracking-widest font-bold mb-4" style={{ color: '#AAB7CC' }}>
              ...
              <div className="mb-5">
                <div className="flex items-center gap-2 mb-3">
                  <span
                    ...
                    style={{ backgroundColor: '#0F172A', color: config.accentColor, border: `1px solid ${config.accentColor}40` }}
                  >1</span>
              ...
              <div className="mb-5">
                ...
                <p className="text-[12px] mb-3 ml-9" style={{ color: '#AAB7CC' }}>
              ...
              >
                <p className="text-[10px] uppercase tracking-widest font-bold mb-2" style={{ color: '#AAB7CC' }}>
                  Ce que tu débloques
                </p>
                <ul className="space-y-1.5">
                  {config.perks.map((perk, i) => (
                    <li key={i} className="flex items-start gap-2 text-[12px]" style={{ color: '#AAB7CC' }}>
              ...
              {/* Confidentialité */}
              <p className="text-[10px] text-center" style={{ color: '#AAB7CC' }}>
