      ...
      {show && (
        ...
        >
          ...
          >
            ...
            <p className="text-papier mb-8 text-sm sm:text-base leading-relaxed max-w-sm mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button onClick={handleDeny} className="px-6 py-3.5 border border-braise/30 rounded-xl text-braise font-semibold hover:bg-braise/10 hover:border-braise/50 transition-all text-sm">
                Je suis mineur
              </button>
            ...
            <p className="text-[11px] text-cendre mt-6">
