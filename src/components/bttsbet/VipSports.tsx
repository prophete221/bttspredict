...
const SPORTS: SportVip[] = [
  { id: 'football', name: 'Football', logo: '/logos/sport-football.svg', accuracy: 79, color: C.neon },
  ...
  { id: 'ufc', name: 'UFC', logo: '/logos/sport-ufc.svg', accuracy: 72, color: '#D4AF37' },
        ...
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-[12px] mt-1" style={{ color: C.textSec }}>
              Pronostics IA sur 6 sports — précision 69-79%
            </p>
          </motion.div>
            ...
            {SPORTS.map(sport => {
              ...
              return (
                <button
                  ...
                  style={{
                    backgroundColor: isActive ? '#F4F7FA' : '#F4F7FA',
                    border: isActive
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 30px rgba(13, 15, 18,0.4)',
              }}
            >
              {/* Top accent */}
              ...
              <div className="p-4 flex items-center gap-3">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: '#1E2228', border: '1px solid ' + activeSport.color + '30' }}>
              ...
              <div className="px-4 pb-4">
                ...
                <div className="space-y-1.5" style={{ filter: 'blur(6px)', opacity: 0.5 }}>
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="flex items-center gap-2 py-2 px-3 rounded-lg" style={{ backgroundColor: 'rgba(244, 247, 250,0.02)' }}>
                      <div className="w-6 h-3 rounded" style={{ backgroundColor: '#1E2228' }} />
                      <div className="flex-1 h-3 rounded" style={{ backgroundColor: '#1E2228' }} />
                      <div className="w-8 h-3 rounded" style={{ backgroundColor: '#1E2228' }} />
                    </div>
                  ))}
                </div>
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#1E2228', border: '1px solid rgba(212, 175, 55, 0.2)' }}
          >
            <div className="flex items-center gap-3">
