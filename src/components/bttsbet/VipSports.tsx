...
const SPORTS: SportVip[] = [
  ...
  { id: 'ufc', name: 'UFC', logo: '/logos/sport-ufc.svg', accuracy: 72, color: '#121212' },
      ...
      <section ref={ref} id="vip-sports" className="section-pad overflow-x-hidden" style={{ paddingTop: '24px', paddingBottom: '24px' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
            ...
            {SPORTS.map(sport => {
              ...
              return (
                <button
                  ...
                  style={{
                    backgroundColor: isActive ? '#111827' : '#111827',
                    border: isActive
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 30px rgba(241, 242, 243,0.4)',
              }}
            >
              {/* Top accent */}
              ...
              <div className="p-4 flex items-center gap-3">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: '#FFFFFF', border: '1px solid ' + activeSport.color + '30' }}>
                ...
                <div className="flex items-center gap-1.5 px-2 py-1 rounded-full"
                  style={{ backgroundColor: 'rgba(18, 18, 18, 0.1)', border: '1px solid rgba(18, 18, 18, 0.2)' }}>
              ...
              <div className="px-4 pb-4">
                ...
                <div className="space-y-1.5" style={{ filter: 'blur(6px)', opacity: 0.5 }}>
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="flex items-center gap-2 py-2 px-3 rounded-lg" style={{ backgroundColor: 'rgba(17, 24, 39,0.02)' }}>
                      <div className="w-6 h-3 rounded" style={{ backgroundColor: '#FFFFFF' }} />
                      <div className="flex-1 h-3 rounded" style={{ backgroundColor: '#FFFFFF' }} />
                      <div className="w-8 h-3 rounded" style={{ backgroundColor: '#FFFFFF' }} />
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center py-4 mt-2">
                  <button
                    ...
                    style={{
                      ...
                      color: '#F1F2F3',
                      boxShadow: '0 4px 16px rgba(18, 18, 18, 0.3)',
                    }}
                  >
                    🔒 Débloquer le VIP
                  </button>
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#FFFFFF', border: '1px solid rgba(18, 18, 18, 0.2)' }}
          >
            <div className="flex items-center gap-3">
