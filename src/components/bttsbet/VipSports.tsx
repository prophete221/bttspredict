...
const SPORTS: SportVip[] = [
  { id: 'football', name: 'Football', logo: '/logos/sport-football.svg', accuracy: 0, color: C.neon },
  ...
  { id: 'nfl', name: 'NFL', logo: '/logos/sport-nfl.svg', accuracy: 0, color: C.neon },
  { id: 'ufc', name: 'UFC', logo: '/logos/sport-ufc.svg', accuracy: 72, color: '#5146F5' },
        ...
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-[12px] mt-1" style={{ color: C.textSec }}>
              Pronostics IA sur 6 sports — taux réel sur /historique
            </p>
          </motion.div>
            ...
            {SPORTS.map(sport => {
              ...
              return (
                <button
                  ...
                  style={{
                    backgroundColor: isActive ? '#F7F8FF' : '#F7F8FF',
                    border: isActive
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 30px rgba(7, 11, 24,0.4)',
              }}
            >
              {/* Top accent */}
              ...
              <div className="p-4 flex items-center gap-3">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: '#0D1630', border: '1px solid ' + activeSport.color + '30' }}>
                ...
                <div className="flex items-center gap-1.5 px-2 py-1 rounded-full"
                  style={{ backgroundColor: 'rgba(81, 70, 245, 0.1)', border: '1px solid rgba(81, 70, 245, 0.2)' }}>
              ...
              <div className="px-4 pb-4">
                ...
                <div className="space-y-1.5" style={{ filter: 'blur(6px)', opacity: 0.5 }}>
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="flex items-center gap-2 py-2 px-3 rounded-lg" style={{ backgroundColor: 'rgba(247, 248, 255,0.02)' }}>
                      <div className="w-6 h-3 rounded" style={{ backgroundColor: '#0D1630' }} />
                      <div className="flex-1 h-3 rounded" style={{ backgroundColor: '#0D1630' }} />
                      <div className="w-8 h-3 rounded" style={{ backgroundColor: '#0D1630' }} />
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center py-4 mt-2">
                  <button
                    ...
                    style={{
                      ...
                      color: '#070B18',
                      boxShadow: '0 4px 16px rgba(81, 70, 245, 0.3)',
                    }}
                  >
                    🔒 Débloquer le VIP
                  </button>
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#0D1630', border: '1px solid rgba(81, 70, 245, 0.2)' }}
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
                style={{ backgroundColor: 'rgba(81, 70, 245, 0.1)' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#5146F5">
              ...
              <div className="flex-1">
                <div className="text-[12px] font-bold text-papier">Inscription confirmée ?</div>
