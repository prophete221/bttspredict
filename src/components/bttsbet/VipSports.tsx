      ...
      <section ref={ref} id="vip-sports" className="section-pad overflow-x-hidden" style={{ paddingTop: '24px', paddingBottom: '24px' }}>
        <div className="max-w-[440px] sm:max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="p-4 flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5 px-2 py-1 rounded-full"
                  style={{ backgroundColor: 'rgba(45, 91, 255, 0.1)', border: '1px solid rgba(45, 91, 255, 0.2)' }}>
          ...
          <motion.div
            ...
            style={{ backgroundColor: '#1E2228', border: '1px solid rgba(45, 91, 255, 0.2)' }}
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
                style={{ backgroundColor: 'rgba(45, 91, 255, 0.1)' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#2D5BFF">
