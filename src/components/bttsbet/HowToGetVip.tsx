...
export default function HowToGetVip() {
  ...
  return (
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(15, 23, 42, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div
            ...
            style={{
              background: 'rgba(22, 199, 163, 0.06)',
              border: '1px solid rgba(22, 199, 163, 0.20)',
              color: '#16C7A3',
            }}
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#16C7A3' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #16C7A3, #22C55E)'
                        : '#16C7A3',
                      color: '#0B1220',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(22, 199, 163, 0.08), rgba(22, 199, 163, 0.08))',
            border: '1px solid rgba(22, 199, 163, 0.25)',
          }}
        >
