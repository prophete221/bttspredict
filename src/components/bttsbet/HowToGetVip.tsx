      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div
            ...
            style={{
              background: 'rgba(216, 186, 145, 0.06)',
              border: '1px solid rgba(216, 186, 145, 0.20)',
              color: '#D8BA91',
            }}
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#D8BA91' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #D8BA91, #A3B5A8)'
                        : '#D8BA91',
                      color: '#090A0B',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(216, 186, 145, 0.08), rgba(216, 186, 145, 0.08))',
            border: '1px solid rgba(216, 186, 145, 0.25)',
          }}
        >
          ...
          <a
            ...
            style={{
              background: 'linear-gradient(135deg, #D8BA91, #FFA500)',
              color: '#090A0B',
