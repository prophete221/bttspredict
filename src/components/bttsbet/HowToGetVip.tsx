...
const STEPS = [
  ...
  {
    num: '3',
    title: 'Activation via lien affilié',
    desc: "Inscription via lien affilié trackée automatiquement via le tag VISION221. Pas de capture nécessaire. Si problème, contact support avec ID utilisateur uniquement, pas de capture bancaire.",
    icon: (
  ...
  },
  {
    ...
    desc: "Ton accès VIP est activé manuellement par notre équipe. Tu reçois confirmation par email/WhatsApp et tu accèdes aux pronostics premium immédiatement.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const VIP_FAQ = [
  ...
  },
  {
    ...
    a: "6 sports : Football (BTTS + Over 2.5), Tennis (ATP/WTA/Grand Chelem), NBA, NFL, UFC/MMA, et Handball. Taux de réussite réel calculé en temps réel (voir /historique).",
  },
  {
  ...
  },
  {
    ...
    a: "Non. Aucun résultat n'est garanti — les paris sportifs comportent des risques. Notre taux réel (voir /historique) reflète nos performances passées vérifiables, pas une garantie future.",
  },
]
...
export default function HowToGetVip() {
  ...
  return (
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(13, 22, 48, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div
            ...
            style={{
              ...
              border: '1px solid rgba(81, 70, 245, 0.20)',
              color: '#5146F5',
            }}
          >
            ...
            >
              ...
              <div className="flex-shrink-0">
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #5146F5, #5146F5)',
                    color: '#070B18',
                  }}
                >
                  {step.num}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#5146F5' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #5146F5, #A8E063)'
                        : '#5146F5',
                      color: '#070B18',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            ...
            border: '1px solid rgba(81, 70, 245, 0.25)',
          }}
        >
          <div className="text-2xl mb-2">⏱️</div>
          <h3 className="text-papier font-bold text-lg mb-1">Essai VIP 1 jour</h3>
          <p className="text-cendre text-xs mb-4 max-w-sm mx-auto">
        ...
        {/* Mini FAQ VIP */}
        <div>
          <h3 className="text-xl font-bold text-papier mb-4 text-center">FAQ VIP — Questions fréquentes</h3>
          <div className="space-y-2">
            {VIP_FAQ.map((item, i) => (
              <div
                key={i}
                className="rounded-lg overflow-hidden"
                style={{ background: 'rgba(13, 22, 48, 0.6)', border: '1px solid #0D1630' }}
              >
                <button
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full flex items-center justify-between p-4 text-left"
                >
                  <span className="text-papier text-sm font-medium pr-3">{item.q}</span>
                  <span
