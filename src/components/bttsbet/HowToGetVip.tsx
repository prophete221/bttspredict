    ...
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(15, 20, 36, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div
            ...
            style={{
              ...
              border: '1px solid rgba(45, 91, 255, 0.20)',
              color: '#2D5BFF',
            }}
          >
        ...
        <div className="space-y-3 mb-10">
          {STEPS.map((step, i) => (
            <motion.div
              ...
              style={{ background: 'rgba(15, 20, 36, 0.6)', border: '1px solid rgba(45, 91, 255, 0.08)' }}
            >
              {/* Numéro + icône */}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#2D5BFF' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #2D5BFF, #00A87E)'
                        : '#D4AF37',
                      color: '#0D0F12',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(212, 175, 55, 0.08), rgba(45, 91, 255, 0.08))',
          ...
          <div className="space-y-2">
            {VIP_FAQ.map((item, i) => (
              <div
                ...
                style={{ background: 'rgba(15, 20, 36, 0.6)', border: '1px solid #1E2228' }}
              >
                <button
