...
export default function HowToGetVip() {
  ...
  return (
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(241, 242, 243, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#121212' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #121212, #A8E063)'
                        : '#121212',
                      color: '#F1F2F3',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(18, 18, 18, 0.08), rgba(18, 18, 18, 0.08))',
        ...
        >
          ...
          <a
            ...
            style={{
              background: 'linear-gradient(135deg, #121212, #121212)',
              color: '#F1F2F3',
              boxShadow: '0 4px 20px rgba(18, 18, 18, 0.3)',
            }}
          >
