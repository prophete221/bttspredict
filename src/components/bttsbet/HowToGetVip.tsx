    ...
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(15, 20, 36, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-3 mb-10">
          {STEPS.map((step, i) => (
            <motion.div
              ...
              style={{ background: 'rgba(15, 20, 36, 0.6)', border: '1px solid rgba(201, 162, 39, 0.08)' }}
            >
              {/* Numéro + icône */}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#C9A227' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #C9A227, #3DDC97)'
                        : '#C9A227',
                      color: '#07080C',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(201, 162, 39, 0.08), rgba(201, 162, 39, 0.08))',
        ...
        >
          ...
          <a
            ...
            style={{
              background: 'linear-gradient(135deg, #C9A227, #FFA500)',
              color: '#07080C',
          ...
          <div className="space-y-2">
            {VIP_FAQ.map((item, i) => (
              <div
                ...
                style={{ background: 'rgba(15, 20, 36, 0.6)', border: '1px solid #0F1219' }}
              >
                <button
