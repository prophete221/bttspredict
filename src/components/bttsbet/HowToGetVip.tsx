            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#16A36A' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #16A36A, #16A36A)'
                        : '#16A36A',
                      color: '#07111F',
                    }}
                  >
        ...
        >
          ...
          <a
            ...
            style={{
              background: 'linear-gradient(135deg, #16A36A, #16A36A)',
              color: '#07111F',
              boxShadow: '0 4px 20px rgba(199, 244, 100, 0.3)',
            }}
          >
          ...
          <div className="space-y-2">
            {VIP_FAQ.map((item, i) => (
              <div
                ...
                style={{ background: 'rgba(7, 17, 26, 0.6)', border: '1px solid #0D1B2A' }}
              >
                <button
