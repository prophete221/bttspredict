...
const STEPS = [
  ...
  {
    num: '2',
    title: 'Effectue un dépôt minimum',
    desc: 'Dépose au moins 200 XOF sur Linebet (500 XOF sur 888starz) via Wave, Orange Money, Free Money ou carte bancaire.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section id="how-to-get-vip" className="py-12 sm:py-16 px-4" style={{ background: 'rgba(15, 20, 36, 0.4)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div
            ...
            style={{
              ...
              border: '1px solid rgba(0, 196, 154, 0.20)',
              color: '#00C49A',
            }}
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ color: '#00C49A' }}>{step.icon}</span>
                  ...
                  <a
                    ...
                    style={{
                      background: step.cta.color === 'emerald'
                        ? 'linear-gradient(135deg, #00C49A, #00A882)'
                        : '#FFD700',
                      color: '#0D1117',
                    }}
                  >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(255, 215, 0, 0.08), rgba(0, 196, 154, 0.08))',
