        ...
        <div className="bg-dark-900 border border-edge rounded-lg p-3 sm:p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1.5">
              <div className="w-5 h-5 rounded bg-success/15 border border-success/30 flex items-center justify-center">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#5AF2A6" strokeWidth="2.5">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="space-y-2">
              ...
              <>
                <div className="flex items-baseline justify-between">
                  <span className="text-xl sm:text-2xl font-bold" style={{ color: bttsPred.prediction === 'Oui' ? undefined : '#9BB8BD' }} >
            ...
            <div className="space-y-2 border-l border-edge/40 pl-3 sm:pl-4">
              ...
              <>
                <div className="flex items-baseline justify-between">
                  <span className="text-xl sm:text-2xl font-bold" style={{ color: over25Pred.prediction === 'Oui' ? undefined : '#9BB8BD' }}>
        ...
        {loading ? (
          ...
          <div className="squircle-xl p-10 text-center">
            <div className="w-14 h-14 bg-dark-800 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-edge">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9BB8BD" strokeWidth="1.5">
                <circle cx="12" cy="12" r="10" />
        ...
        <div className="text-center mt-5">
          <a
            ...
            style={{
              ...
              color: '#09141D',
              boxShadow: '0 4px 16px rgba(24, 224, 181, 0.25)',
            }}
          >
