          ...
          <div className="text-center py-16">
            <div className="glass-3d rounded-2xl p-8 max-w-sm mx-auto">
              <div className="w-14 h-14 bg-braise/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5146F5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="text-center py-16">
            <div className="glass-3d rounded-2xl p-8 max-w-sm mx-auto">
              <div className="w-14 h-14 bg-edge rounded-2xl flex items-center justify-center mx-auto mb-4">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#A5ABC5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
