  ...
  return (
    <section id="vip" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* CTA Section */}
        <div className="relative overflow-hidden rounded-3xl p-8 lg:p-12" style={{ background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.2) 0%, rgba(249, 115, 22, 0.1) 100%)', border: '1px solid rgba(212, 175, 55, 0.2)' }}>
          {/* Decorative */}
