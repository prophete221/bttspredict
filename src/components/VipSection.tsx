  ...
  return (
    <section id="vip" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* CTA Section */}
        <div className="relative overflow-hidden rounded-3xl p-8 lg:p-12" style={{ background: 'linear-gradient(135deg, rgba(81, 70, 245, 0.2) 0%, rgba(81, 70, 245, 0.1) 100%)', border: '1px solid rgba(81, 70, 245, 0.2)' }}>
          {/* Decorative */}
