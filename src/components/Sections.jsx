...
export function StatsSection() {
  ...
  const stats = [
    { animatedValue: `~${precisionCount}%`, label: 'Précision historique', desc: 'Sur pronostics archivés (voir /historique)', icon: 'check', color: 'emerald' },
          ...
          <div className="card card-3d p-5 sm:p-6 stat-card-animated overflow-hidden">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              >
                ...
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#A8E063" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
